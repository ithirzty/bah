//COMPILE WITH: 'gcc windows.c -static -w  -static -w C:/Bah/libs/gc.a -lpthread -lm -g'
...
;                            
                            ____BAH_COMPILER_VAR_103 = memoryAlloc(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5);
                            
                            strncpy(____BAH_COMPILER_VAR_103+currStrOff, "gcc ", strLen_0);
                            currStrOff += strLen_0;
                            
                            strncpy(____BAH_COMPILER_VAR_103+currStrOff, randFileName, strLen_1);
                            currStrOff += strLen_1;
                            
                            strncpy(____BAH_COMPILER_VAR_103+currStrOff, " ", strLen_2);
                            currStrOff += strLen_2;
                            
                            strncpy(____BAH_COMPILER_VAR_103+currStrOff, isStatic, strLen_3);
                            currStrOff += strLen_3;
                            
                            strncpy(____BAH_COMPILER_VAR_103+currStrOff, " -w -o ", strLen_4);
                            currStrOff += strLen_4;
                            
                            strncpy(____BAH_COMPILER_VAR_103+currStrOff, fileName, strLen_5);
                            currStrOff += strLen_5;
...
;                            
                            ____BAH_COMPILER_VAR_105 = memoryAlloc(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4);
                            
                            strncpy(____BAH_COMPILER_VAR_105+currStrOff, "gcc ", strLen_0);
                            currStrOff += strLen_0;
                            
                            strncpy(____BAH_COMPILER_VAR_105+currStrOff, fileName, strLen_1);
                            currStrOff += strLen_1;
                            
                            strncpy(____BAH_COMPILER_VAR_105+currStrOff, " ", strLen_2);
                            currStrOff += strLen_2;
                            
                            strncpy(____BAH_COMPILER_VAR_105+currStrOff, isStatic, strLen_3);
                            currStrOff += strLen_3;
                            
                            strncpy(____BAH_COMPILER_VAR_105+currStrOff, " -w ", strLen_4);
                            currStrOff += strLen_4;
                            
                        }
                        char * gccArgs =  ____BAH_COMPILER_VAR_105;
array(char *)* cLibs =  compilerState.cLibs;
long int i =  0;
while ((i<len(cLibs))) {
char * l =  cLibs->data[i];
...
;                            
                            ...
                            strncpy(____BAH_COMPILER_VAR_106+currStrOff, gccArgs, strLen_0);
                            currStrOff += strLen_0;
                            
                            strncpy(____BAH_COMPILER_VAR_106+currStrOff, " -", strLen_1);
                            currStrOff += strLen_1;
                            
                            strncpy(____BAH_COMPILER_VAR_106+currStrOff, l, strLen_2);
                            currStrOff += strLen_2;
                            
                        }
                        gccArgs =  ____BAH_COMPILER_VAR_106;
i =  i + 1;
};
...
;                            
                            ...
                            strncpy(____BAH_COMPILER_VAR_107+currStrOff, "//COMPILE WITH: '", strLen_0);
                            currStrOff += strLen_0;
                            
                            strncpy(____BAH_COMPILER_VAR_107+currStrOff, gccArgs, strLen_1);
                            currStrOff += strLen_1;
                        ...
                        OUTPUT =  concatenateRopes(rope(____BAH_COMPILER_VAR_107),OUTPUT);
struct fileStream fs =  {};
fs.isValid = fileStream__isValid;
fs.open = fileStream__open;
fs.close = fileStream__close;
...
;                            
                            ...
                            strncpy(____BAH_COMPILER_VAR_108+currStrOff, "\e[1;32mDone. (compiled in ", strLen_0);
                            currStrOff += strLen_0;
                            
                            strncpy(____BAH_COMPILER_VAR_108+currStrOff, intToStr(totalTime / 1000000), strLen_1);
                            currStrOff += strLen_1;
                            
                            strncpy(____BAH_COMPILER_VAR_108+currStrOff, "ms)\e[0m", strLen_2);
                            currStrOff += strLen_2;
