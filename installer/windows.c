...
register long int i = 0;
while ((i<len(arr))) {
char * ____BAH_COMPILER_VAR_102 =null;char * ____BAH_COMPILER_VAR_103 =jsonEscapeStr(arr->data[i]);
        {
            unsigned int currStrOff = 0;
            unsigned int strLen_0 = strlen(____BAH_COMPILER_VAR_103);
unsigned int strLen_1 = strlen("\"");
unsigned int strLen_2 = strlen("\"");
unsigned int strLen_3 = strlen(s);
;                            
            ____BAH_COMPILER_VAR_102 = memoryAllocSTR(1+strLen_0+strLen_1+strLen_2+strLen_3);
            
                    memcpy(____BAH_COMPILER_VAR_102+currStrOff, s, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_102+currStrOff, "\"", strLen_2);
                    currStrOff += strLen_2;
                    
            memcpy(____BAH_COMPILER_VAR_102+currStrOff, ____BAH_COMPILER_VAR_103, strLen_0);
            currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_106 =null;char * ____BAH_COMPILER_VAR_107 =toJson__inner(*ae,false,tabs);
        {
            unsigned int currStrOff = 0;
            unsigned int strLen_0 = strlen(s);
unsigned int strLen_1 = strlen(____BAH_COMPILER_VAR_107);
;                            
...
char * ____BAH_COMPILER_VAR_113 =null;char * ____BAH_COMPILER_VAR_114 =toJson(e);char * ____BAH_COMPILER_VAR_115 =intToStr(line);char * ____BAH_COMPILER_VAR_116 =toJson(____BAH_COMPILER_VAR_112);
        {
            unsigned int currStrOff = 0;
            unsigned int strLen_0 = strlen(____BAH_COMPILER_VAR_114);
unsigned int strLen_1 = strlen("\n    },\n    ");
unsigned int strLen_2 = strlen("\",\n        \"element\": ");
unsigned int strLen_3 = strlen(____BAH_COMPILER_VAR_115);
unsigned int strLen_4 = strlen(":");
unsigned int strLen_5 = strlen(compilerState.currentFile);
unsigned int strLen_6 = strlen(",\n        \"path\": \"");
unsigned int strLen_7 = strlen(____BAH_COMPILER_VAR_116);
...
void ** ____BAH_COMPILER_VAR_141 = (void **)((char*)(____BAH_COMPILER_VAR_127) + offsetof(struct variable, declScope));
struct reflectElement ____BAH_COMPILER_VAR_142 = __reflect(____BAH_COMPILER_VAR_141, sizeof(void *), "ptr", "declScope", 0, 0, 0, 0, offsetof(struct variable, declScope));
...
struct rope** ____BAH_COMPILER_VAR_145 = (struct rope**)((char*)(____BAH_COMPILER_VAR_127) + offsetof(struct variable, declRope));
void ** ____BAH_COMPILER_VAR_147 = (void **)((char*)(____BAH_COMPILER_VAR_145) + offsetof(struct rope, left));
struct reflectElement ____BAH_COMPILER_VAR_148 = __reflect(____BAH_COMPILER_VAR_147, sizeof(void *), "ptr", "left", 0, 0, 0, 0, offsetof(struct rope, left));
void ** ____BAH_COMPILER_VAR_149 = (void **)((char*)(____BAH_COMPILER_VAR_145) + offsetof(struct rope, right));
struct reflectElement ____BAH_COMPILER_VAR_150 = __reflect(____BAH_COMPILER_VAR_149, sizeof(void *), "ptr", "right", 0, 0, 0, 0, offsetof(struct rope, right));
char ** ____BAH_COMPILER_VAR_151 = (char **)((char*)(____BAH_COMPILER_VAR_145) + offsetof(struct rope, str));
struct reflectElement ____BAH_COMPILER_VAR_152 = __reflect(____BAH_COMPILER_VAR_151, sizeof(char *), "cpstring", "str", 0, 0, 0, 0, offsetof(struct rope, str));
int* ____BAH_COMPILER_VAR_153 = (int*)((char*)(____BAH_COMPILER_VAR_145) + offsetof(struct rope, lCount));
struct reflectElement ____BAH_COMPILER_VAR_154 = __reflect(____BAH_COMPILER_VAR_153, sizeof(int), "int32", "lCount", 0, 0, 0, 0, offsetof(struct rope, lCount));
int* ____BAH_COMPILER_VAR_155 = (int*)((char*)(____BAH_COMPILER_VAR_145) + offsetof(struct rope, len));
struct reflectElement ____BAH_COMPILER_VAR_156 = __reflect(____BAH_COMPILER_VAR_155, sizeof(int), "int32", "len", 0, 0, 0, 0, offsetof(struct rope, len));
int* ____BAH_COMPILER_VAR_157 = (int*)((char*)(____BAH_COMPILER_VAR_145) + offsetof(struct rope, totalLen));
struct reflectElement ____BAH_COMPILER_VAR_158 = __reflect(____BAH_COMPILER_VAR_157, sizeof(int), "int32", "totalLen", 0, 0, 0, 0, offsetof(struct rope, totalLen));

        array(struct reflectElement) * ____BAH_COMPILER_VAR_146 = memoryAlloc(sizeof(array(struct reflectElement)));
        ____BAH_COMPILER_VAR_146->elemSize = sizeof(struct reflectElement);
        ____BAH_COMPILER_VAR_146->length = 6;
        ____BAH_COMPILER_VAR_146->data = memoryAlloc(____BAH_COMPILER_VAR_146->length * ____BAH_COMPILER_VAR_146->elemSize);
        ____BAH_COMPILER_VAR_146->data[0] = ____BAH_COMPILER_VAR_148;
____BAH_COMPILER_VAR_146->data[1] = ____BAH_COMPILER_VAR_150;
____BAH_COMPILER_VAR_146->data[2] = ____BAH_COMPILER_VAR_152;
____BAH_COMPILER_VAR_146->data[3] = ____BAH_COMPILER_VAR_154;
____BAH_COMPILER_VAR_146->data[4] = ____BAH_COMPILER_VAR_156;
____BAH_COMPILER_VAR_146->data[5] = ____BAH_COMPILER_VAR_158;
struct reflectElement ____BAH_COMPILER_VAR_159 = __reflect(____BAH_COMPILER_VAR_145, sizeof(struct rope), "rope*", "declRope", 0, 0, 1, ____BAH_COMPILER_VAR_146, offsetof(struct variable, declRope));
char* ____BAH_COMPILER_VAR_160 = (char*)((char*)(____BAH_COMPILER_VAR_127) + offsetof(struct variable, canBeReg));
struct reflectElement ____BAH_COMPILER_VAR_161 = __reflect(____BAH_COMPILER_VAR_160, sizeof(char), "bool", "canBeReg", 0, 0, 0, 0, offsetof(struct variable, canBeReg));
char* ____BAH_COMPILER_VAR_162 = (char*)((char*)(____BAH_COMPILER_VAR_127) + offsetof(struct variable, isReg));
struct reflectElement ____BAH_COMPILER_VAR_163 = __reflect(____BAH_COMPILER_VAR_162, sizeof(char), "bool", "isReg", 0, 0, 0, 0, offsetof(struct variable, isReg));
void ** ____BAH_COMPILER_VAR_164 = (void **)((char*)(____BAH_COMPILER_VAR_127) + offsetof(struct variable, lastSet));
struct reflectElement ____BAH_COMPILER_VAR_165 = __reflect(____BAH_COMPILER_VAR_164, sizeof(void *), "ptr", "lastSet", 0, 0, 0, 0, offsetof(struct variable, lastSet));
char* ____BAH_COMPILER_VAR_166 = (char*)((char*)(____BAH_COMPILER_VAR_127) + offsetof(struct variable, isArg));
struct reflectElement ____BAH_COMPILER_VAR_167 = __reflect(____BAH_COMPILER_VAR_166, sizeof(char), "bool", "isArg", 0, 0, 0, 0, offsetof(struct variable, isArg));
        ...
        ____BAH_COMPILER_VAR_128->length = 13;
...
____BAH_COMPILER_VAR_128->data[8] = ____BAH_COMPILER_VAR_159;
____BAH_COMPILER_VAR_128->data[9] = ____BAH_COMPILER_VAR_161;
____BAH_COMPILER_VAR_128->data[10] = ____BAH_COMPILER_VAR_163;
____BAH_COMPILER_VAR_128->data[11] = ____BAH_COMPILER_VAR_165;
____BAH_COMPILER_VAR_128->data[12] = ____BAH_COMPILER_VAR_167;
struct reflectElement ____BAH_COMPILER_VAR_168 = __reflect(____BAH_COMPILER_VAR_127, sizeof(struct variable), "variable*", "v", 0, 0, 1, ____BAH_COMPILER_VAR_128, 0);
debugPrint("var_end",line,____BAH_COMPILER_VAR_168);
}
i = i+1;
};
};
...
long int pos = 0;
if ((tp!=null)) {
struct fileMap ____BAH_COMPILER_VAR_169 = {};
____BAH_COMPILER_VAR_169.handle = -1;
____BAH_COMPILER_VAR_169.p= null;
#define fm ____BAH_COMPILER_VAR_169
...
;                            
            ____BAH_COMPILER_VAR_170 = memoryAllocSTR(1+strLen_0+strLen_1+strLen_2);
                    ...
                    memcpy(____BAH_COMPILER_VAR_170+currStrOff, "'", strLen_2);
                    currStrOff += strLen_2;
                    
            memcpy(____BAH_COMPILER_VAR_170+currStrOff, t->ogCont, strLen_0);
            currStrOff += strLen_0;
        
            memcpy(____BAH_COMPILER_VAR_170+currStrOff, "'", strLen_1);
            currStrOff += strLen_1;
        
        }string__replace(&ffmt,"{TOKEN}",____BAH_COMPILER_VAR_170);
...
char * ____BAH_COMPILER_VAR_171 =null;char * ____BAH_COMPILER_VAR_172 =arrToStr(errCont);
        {
            unsigned int currStrOff = 0;
            unsigned int strLen_0 = strlen(____BAH_COMPILER_VAR_172);
...
;                            
            ____BAH_COMPILER_VAR_171 = memoryAllocSTR(1+strLen_0+strLen_1+strLen_2);
                    ...
                    memcpy(____BAH_COMPILER_VAR_171+currStrOff, "\e[1;31m", strLen_2);
                    currStrOff += strLen_2;
                    
            memcpy(____BAH_COMPILER_VAR_171+currStrOff, ____BAH_COMPILER_VAR_172, strLen_0);
            currStrOff += strLen_0;
        
            memcpy(____BAH_COMPILER_VAR_171+currStrOff, "\e[1;37m", strLen_1);
            currStrOff += strLen_1;
        
        }char * ____BAH_COMPILER_VAR_173 =____BAH_COMPILER_VAR_171;array(char)* errTk = strToArr(____BAH_COMPILER_VAR_173);
register long int ii = 0;
for (; (ii<len(errTk)); ++ii) {
...
;                            
        ...
        }char * ____BAH_COMPILER_VAR_319 =____BAH_COMPILER_VAR_316;if ((fileExists(____BAH_COMPILER_VAR_319)==0)) {
return false;
}
...
;                            
        ...
        }__BAH_panic(____BAH_COMPILER_VAR_338,"/home/alois/Documents/bah-bah/src/parser.bah:243");
}
