...
for (; (i<size); i = i+1) {
                        ...
                        if (arr->length <= i) {
                            ...
                            __BAH_panic((char*)buff, (char*)"/opt/bah/builtin.bah:173");
                        };
...
for (; (j<len(__Bah_fnNames)); j = j+1) {
                        ...
                        if (__Bah_fnNames->length <= j) {
                            ...
                            __BAH_panic((char*)buff, (char*)"/opt/bah/builtin.bah:177");
                        };
...
;                            
                    ____BAH_COMPILER_VAR_303 = memoryAllocSTR(1 + strLen_0 + strLen_2 + strLen_4);
                        ...
                        memcpy(____BAH_COMPILER_VAR_303+currStrOff, "... ", strLen_4);
                        currStrOff += strLen_4;
                        
                }
                print(____BAH_COMPILER_VAR_303);
...
;                            
                ...
                __BAH_panic(____BAH_COMPILER_VAR_813,"/home/alois/Documents/bah-bah/src/main.bah:229");
}
shouldOnlyDecl = false;
if ((flags.isSet(&flags,"l")==1)) {
OUTPUT = rope("");
