...
clock_serv_t cclock;
mach_timespec_t mts;
void * ____BAH_COMPILER_VAR_49 =mach_host_self();host_get_clock_service(____BAH_COMPILER_VAR_49,CALENDAR_CLOCK,&cclock);
clock_get_time(cclock,&mts);
void * ____BAH_COMPILER_VAR_50 =mach_task_self();mach_port_deallocate(____BAH_COMPILER_VAR_50,cclock);
...
while ((i<len(members))) {
                    ...
                    if (members->length <= i) {
                        char buff[300];
                        snprintf(buff, 299, "array: members[%d] with length %d", i, members->length);
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/var.bah:327");
                    };
                    struct structMemb* m =  members->data[i];
...
while ((i<len(es->methods))) {
                    ...
                    if (es->methods->length <= i) {
                        ...
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/var.bah:364");
                    };
...
while ((i<len(methods))) {
                    ...
                    if (methods->length <= i) {
                        ...
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/var.bah:372");
                    };
...
char * genCompilerVar(){
char * ____BAH_COMPILER_VAR_183 =intToStr(NB_COMP_VAR);char * ____BAH_COMPILER_VAR_184 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_184+currStrOff, "____BAH_COMPILER_VAR_", strLen_0);
                    currStrOff += strLen_0;
...
while ((j<len(arr))) {
                    ...
                    if (arr->length <= j) {
                        ...
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/var.bah:401");
                    };
...
for (; (i<len(a)); i =  i+1) {
                    ...
                    if (a->length <= i) {
                        char buff[300];
                        snprintf(buff, 299, "array: a[%d] with length %d", i, a->length);
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/var.bah:413");
                    };
                    long int c =  a->data[i];
c =  c - (long int)97;
if ((c<0)) {
...
if ((isObject==true)) {
char * ____BAH_COMPILER_VAR_185 =pathToVarName(compilerState.currentFile);char * ____BAH_COMPILER_VAR_186 =null;
                {
                    long int currStrOff = 0;
...
char * evals =  "";
char * ____BAH_COMPILER_VAR_187 =intToStr(len(compilerState.evals));char * ____BAH_COMPILER_VAR_188 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_188+currStrOff, "volatile struct __eval_binding __tmp__evals_bindings[", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_188+currStrOff, ____BAH_COMPILER_VAR_187, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_188+currStrOff, "] = {", strLen_2);
                    currStrOff += strLen_2;
...
for (; (i<len(compilerState.evals)); i =  i+1) {
                    ...
                    if (compilerState.evals->length <= i) {
                        ...
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/var.bah:435");
                    };
...
long int strLen_4 = strlen("\n        }");
;                            
                    ____BAH_COMPILER_VAR_189 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4);
                    
                    memcpy(____BAH_COMPILER_VAR_189+currStrOff, "{\n            .name = \"", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_189+currStrOff, e, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_189+currStrOff, "\",\n            .evalFn = __Bah_eval_", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_189+currStrOff, e, strLen_3);
                    currStrOff += strLen_3;
...
char * ____BAH_COMPILER_VAR_193 =intToStr(len(compilerState.evals));char * ____BAH_COMPILER_VAR_194 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_194+currStrOff, "__evals_bindings = __tmp__evals_bindings; __evals_length = ", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_195+currStrOff, evalsTMPDecl, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_195+currStrOff, "\n    void __attribute__((optimize(\"O0\"))) ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_195+currStrOff, name, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_196+currStrOff, evals, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_197 =at.str((struct string*)&at);if (isRCPtype(____BAH_COMPILER_VAR_197,elems)) {
...
struct variable* arrElem =  ____BAH_COMPILER_VAR_198;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_199+currStrOff, v->name, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_199+currStrOff, "->data[arrElemIndex]", strLen_1);
                    currStrOff += strLen_1;
                    
                }
                arrElem->name =  ____BAH_COMPILER_VAR_199;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_200+currStrOff, ")-1; arrElemIndex >= 0; arrElemIndex--) {\n                        ", strLen_6);
                    currStrOff += strLen_6;
                    
                }
                r =  rope(____BAH_COMPILER_VAR_200)->add(rope(____BAH_COMPILER_VAR_200), decrVar(arrElem,elems))->add(rope(____BAH_COMPILER_VAR_200)->add(rope(____BAH_COMPILER_VAR_200), decrVar(arrElem,elems)), rope("\n                    };\n                }\n                RCP_decrRCP(arrDataRCP);\n            }\n            RCP_decrRCP(arrRCP);\n            };\n            "));
}
else {
...
;                            
                    ____BAH_COMPILER_VAR_202 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8);
                    ...
                    memcpy(____BAH_COMPILER_VAR_202+currStrOff, "->destroy(", strLen_4);
                    currStrOff += strLen_4;
                    ...
                    memcpy(____BAH_COMPILER_VAR_202+currStrOff, v->name, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_202+currStrOff, "->queue);\n            };\n            RCP_decrRCP(chanRCP);\n        };", strLen_8);
                    currStrOff += strLen_8;
...
struct variable* nv =  ____BAH_COMPILER_VAR_203;
*nv =  *v;
v =  nv;
v->type =  "mapWrapper*";
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, "__RCP_clean_", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, s->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, "(", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, amp, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, v->name, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, ", ", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_204+currStrOff, heap, strLen_6);
                    currStrOff += strLen_6;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_206+currStrOff, "RCP_incrCounter(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_206+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_206+currStrOff, ".__RCP_counter);", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_207+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_208+currStrOff, "rcp.bah", strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_209+currStrOff, "fastrcp.bah", strLen_1);
                    currStrOff += strLen_1;
...
for (; (i<len(elems->vars)); i =  i+1) {
                    ...
                    if (elems->vars->length <= i) {
                        char buff[300];
                        snprintf(buff, 299, "array: elems->vars[%d] with length %d", i, elems->vars->length);
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/mem.bah:100");
                    };
                    struct variable* v =  elems->vars->data[i];
...
for (; (i<len(elems->vars)); i =  i+1) {
                    ...
                    if (elems->vars->length <= i) {
                        char buff[300];
                        snprintf(buff, 299, "array: elems->vars[%d] with length %d", i, elems->vars->length);
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/mem.bah:114");
                    };
                    struct variable* v =  elems->vars->data[i];
...
char * ____BAH_COMPILER_VAR_211 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_212 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_212+currStrOff, ____BAH_COMPILER_VAR_211, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_212+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_212+currStrOff, av->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_212+currStrOff, " =", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_212+currStrOff, c, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_212+currStrOff, ";", strLen_5);
                    currStrOff += strLen_5;
...
while ((i<len(s->members))) {
                    ...
                    if (s->members->length <= i) {
                        ...
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/mem.bah:141");
                    };
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_214+currStrOff, "e->", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_214+currStrOff, m->name, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_215+currStrOff, "Strcture '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_215+currStrOff, s->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_215+currStrOff, "' has a self-referenced member '", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_215+currStrOff, m->name, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_215+currStrOff, "'. May lead to memory leaks, recompile the program without the '-rcp' flag if memory leaks happens.", strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_216+currStrOff, "__RCP_clean_", strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_216+currStrOff, amp, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_216+currStrOff, "e->", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_216+currStrOff, m->name, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_216+currStrOff, ", ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_216+currStrOff, heap, strLen_7);
                    currStrOff += strLen_7;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_217+currStrOff, "void* __RCP_clean_", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_217+currStrOff, s->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_217+currStrOff, "(struct ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_217+currStrOff, s->name, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_217+currStrOff, "* e, int heap) {\n        if(heap == 1) {\n            struct RCP* srcp = RCP_request(e);\n            if (srcp != null) {\n                if (srcp->c == 1) {\n                    ", strLen_4);
                    currStrOff += strLen_4;
...
while ((i<len(compilerState.RCPvars))) {
                    ...
                    if (compilerState.RCPvars->length <= i) {
                        ...
                        __BAH_panic(buff, "/home/alois/Documents/bah-bah/src/mem.bah:183");
                    };
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_220+currStrOff, "__Bah_safe_string(", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_223+currStrOff, ogCont, strLen_1);
                    currStrOff += strLen_1;
                    ...
                    memcpy(____BAH_COMPILER_VAR_223+currStrOff, m->name, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_228+currStrOff, ASCII_BLUE, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_228+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_228+currStrOff, ASCII_RESET, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_228+currStrOff, " = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_228+currStrOff, ASCII_MAGENTA, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_228+currStrOff, ct, strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, nameColor, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, fn->name, strLen_2);
                    currStrOff += strLen_2;
                    ...
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, fnArgs, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, ") -> ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, ASCII_GREEN, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, line, strLen_8);
                    currStrOff += strLen_8;
                    ...
                    memcpy(____BAH_COMPILER_VAR_235+currStrOff, fnArgsValues, strLen_11);
                    currStrOff += strLen_11;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_238+currStrOff, compilerState.currentFile, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_238+currStrOff, ":", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_238+currStrOff, ____BAH_COMPILER_VAR_237, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, pvo.markup, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, " AND ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, nvo.markup, strLen_3);
                    currStrOff += strLen_3;
                    ...
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, line, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, ASCII_RESET, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, "\\n\"", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_239+currStrOff, values, strLen_9);
                    currStrOff += strLen_9;
...
;                            
                ...
                fs.open((struct fileStream*)&fs,____BAH_COMPILER_VAR_241,"r");
...
;                            
                ...
                fs.createFile((struct fileStream*)&fs,____BAH_COMPILER_VAR_243);
return;
}
char * ____BAH_COMPILER_VAR_244 =fs.readContent((struct fileStream*)&fs);struct jsonElement* j =  parseJson(____BAH_COMPILER_VAR_244);
fs.close((struct fileStream*)&fs);
...
j->scan((struct jsonElement*)j,____BAH_COMPILER_VAR_265);
if ((cache!=null)) {
}
};
...
struct fileStream fs =  ____BAH_COMPILER_VAR_267;
...
;                            
                ...
                fs.open((struct fileStream*)&fs,____BAH_COMPILER_VAR_268,"w");
...
char * ____BAH_COMPILER_VAR_290 =toJson(____BAH_COMPILER_VAR_289);fs.writeFile((struct fileStream*)&fs,____BAH_COMPILER_VAR_290);
fs.close((struct fileStream*)&fs);
};
...
char * ____BAH_COMPILER_VAR_291 =pathToVarName(cf->file);char * ____BAH_COMPILER_VAR_292 =intToStr(cf->mem);char * ____BAH_COMPILER_VAR_293 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(BAH_DIR);
long int strLen_1 = strlen("cache/");
long int strLen_2 = strlen(____BAH_COMPILER_VAR_291);
long int strLen_3 = strlen(____BAH_COMPILER_VAR_292);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_293+currStrOff, "cache/", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_293+currStrOff, ____BAH_COMPILER_VAR_291, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_293+currStrOff, ____BAH_COMPILER_VAR_292, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_293+currStrOff, ".o.o", strLen_4);
                    currStrOff += strLen_4;
                    
                }
                if ((fileExists(____BAH_COMPILER_VAR_293)==0)) {
return false;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_294+currStrOff, cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_294+currStrOff, " '", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_294+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_294+currStrOff, "'", strLen_3);
                    currStrOff += strLen_3;
                    
                }
                cont =  ____BAH_COMPILER_VAR_294;
i =  i+1;
};
println(cont);
};
struct Elems* dupElems(struct Elems* elems){
struct Elems* ____BAH_COMPILER_VAR_295 = memoryAlloc(sizeof(struct Elems));
____BAH_COMPILER_VAR_295->vars = memoryAlloc(sizeof(array(struct variable*)));
            ____BAH_COMPILER_VAR_295->vars->length = 0;
            ____BAH_COMPILER_VAR_295->vars->elemSize = sizeof(struct variable*);
            ____BAH_COMPILER_VAR_295->structs = memoryAlloc(sizeof(array(struct cStruct*)));
            ____BAH_COMPILER_VAR_295->structs->length = 0;
            ____BAH_COMPILER_VAR_295->structs->elemSize = sizeof(struct cStruct*);
            ____BAH_COMPILER_VAR_295->types = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_295->types->length = 0;
            ____BAH_COMPILER_VAR_295->types->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_295->fns = memoryAlloc(sizeof(array(struct func*)));
            ____BAH_COMPILER_VAR_295->fns->length = 0;
            ____BAH_COMPILER_VAR_295->fns->elemSize = sizeof(struct func*);
            struct Elems* nElems =  ____BAH_COMPILER_VAR_295;
long int j =  0;
...
struct variable* ____BAH_COMPILER_VAR_296 = memoryAlloc(sizeof(struct variable));
...
____BAH_COMPILER_VAR_296->isGlobal = false;
struct variable* nv =  ____BAH_COMPILER_VAR_296;
*nv =  *v;
nv->outterScope =  true;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_297+currStrOff, cCastStr, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_297+currStrOff, ")", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_297+currStrOff, nnnt.cont, strLen_3);
                    currStrOff += strLen_3;
...
if ((isBahDir==false)) {
char * ____BAH_COMPILER_VAR_303 =getDirFromFile(ccstr);char * ____BAH_COMPILER_VAR_304 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(compilerState.currentDir);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_304+currStrOff, ____BAH_COMPILER_VAR_303, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_306+currStrOff, ____BAH_COMPILER_VAR_305, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_307+currStrOff, "File '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_307+currStrOff, ccstr, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_307+currStrOff, "' not recognized.", strLen_2);
                    currStrOff += strLen_2;
                    
                }
                __BAH_panic(____BAH_COMPILER_VAR_307,"/home/alois/Documents/bah-bah/src/parser.bah:246");
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, fn, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, " ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, rcp, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, " -object ", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, verboseCC, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, " -o ", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_308+currStrOff, oName, strLen_8);
                    currStrOff += strLen_8;
...
char * ____BAH_COMPILER_VAR_311 =fileName.str((struct string*)&fileName);char * fn =  absPath(____BAH_COMPILER_VAR_311);
if (((void *)fn==null)) {
char * ____BAH_COMPILER_VAR_312 =fileName.str((struct string*)&fileName);char * ____BAH_COMPILER_VAR_313 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(BAH_DIR);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_313+currStrOff, ____BAH_COMPILER_VAR_312, strLen_1);
                    currStrOff += strLen_1;
...
struct fileStream fs =  ____BAH_COMPILER_VAR_314;
...
isSubObject =  true;
char * ____BAH_COMPILER_VAR_315 =pathToVarName(fn);char * ____BAH_COMPILER_VAR_316 =intToStr(RCPlevel);char * ____BAH_COMPILER_VAR_317 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(BAH_DIR);
long int strLen_1 = strlen("cache/");
long int strLen_2 = strlen(____BAH_COMPILER_VAR_315);
long int strLen_3 = strlen(____BAH_COMPILER_VAR_316);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_317+currStrOff, "cache/", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_317+currStrOff, ____BAH_COMPILER_VAR_315, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_317+currStrOff, ____BAH_COMPILER_VAR_316, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_317+currStrOff, ".o", strLen_4);
                    currStrOff += strLen_4;
                    
                }
                char * oName =  ____BAH_COMPILER_VAR_317;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_318+currStrOff, "w ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_318+currStrOff, oName, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_318+currStrOff, ".o", strLen_2);
                    currStrOff += strLen_2;
...
struct channel * done = channel();
    ...
    void ____BAH_COMPILER_VAR_319(struct {
char * fn;
char * oName;
struct channel * done;
}* args) {
...
char * oName;
struct channel * done;
} ____BAH_COMPILER_VAR_320 = {fn,oName,done};
        pthread_t id;
        GC_pthread_create(&id, 0, ____BAH_COMPILER_VAR_319, &____BAH_COMPILER_VAR_320);
    }; 
    
    parseLines(tokens,elems);
char ok =  *(char*)done->receive(done);
char * ____BAH_COMPILER_VAR_321 =pathToVarName(fn);char * ____BAH_COMPILER_VAR_322 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("__BAH_init");
long int strLen_1 = strlen(____BAH_COMPILER_VAR_321);
long int strLen_2 = strlen("();\n");
;                            
                    ____BAH_COMPILER_VAR_322 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2);
                    
                    memcpy(____BAH_COMPILER_VAR_322+currStrOff, "__BAH_init", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_322+currStrOff, ____BAH_COMPILER_VAR_321, strLen_1);
                    currStrOff += strLen_1;
                ...
                INIT =  INIT->add(INIT, rope(____BAH_COMPILER_VAR_322));
writeCache();
shouldOnlyDecl =  osod;
isSubObject =  oiso;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_323+currStrOff, "#include ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_323+currStrOff, sc, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_324+currStrOff, "(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_324+currStrOff, nestedT.cont, strLen_1);
                    currStrOff += strLen_1;
                ...
                nestedT.cont =  ____BAH_COMPILER_VAR_324;
...
while ((i<len(line))) {
                ...
                int ____BAH_COMPILER_VAR_325 = 0;
                for(int i=len(signs)-1; i != -1; i--) {
                    if (signs->data[i] != 0 && strcmp(signs->data[i], t.cont) == 0) {
                        ____BAH_COMPILER_VAR_325 = 1;
                        break;
                    };
                };
                if (((t.type==TOKEN_TYPE_SYNTAX)&&____BAH_COMPILER_VAR_325)) {
if ((i + 1>=len(line))) {
...
;                            
                ...
                nt.cont =  ____BAH_COMPILER_VAR_326;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_327+currStrOff, nt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                char * c =  ____BAH_COMPILER_VAR_327;
long int tl =  t.line;
long int tp =  t.pos;
...
____BAH_COMPILER_VAR_328.cont = c;
____BAH_COMPILER_VAR_328.ogCont = c;
____BAH_COMPILER_VAR_328.isValue = false;
____BAH_COMPILER_VAR_328.line = tl;
____BAH_COMPILER_VAR_328.pos = tp;
____BAH_COMPILER_VAR_328.type = TOKEN_TYPE_SYNTAX;
struct Tok tmpT =  ____BAH_COMPILER_VAR_328;
...
;                            
                ...
                throwErr(&nt,____BAH_COMPILER_VAR_329);
}
t.isValue =  true;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_330+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_330+currStrOff, ntt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_330+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_330+currStrOff, ptt, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_330+currStrOff, ".", strLen_4);
                    currStrOff += strLen_4;
                    
                }
                throwErr(&strAddTkT,____BAH_COMPILER_VAR_330);
break;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_331+currStrOff, lens, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_331+currStrOff, "long int strLen_", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_331+currStrOff, js, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_331+currStrOff, " = strlen(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_331+currStrOff, strConts->data[j], strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_332+currStrOff, totStrLen, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_332+currStrOff, " + strLen_", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_332+currStrOff, js, strLen_2);
                    currStrOff += strLen_2;
                    
                }
                totStrLen =  ____BAH_COMPILER_VAR_332;
};
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, rstr, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, "+currStrOff, ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, strConts->data[j], strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, ", strLen_", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, js, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, ");\n                    currStrOff += strLen_", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_333+currStrOff, js, strLen_7);
                    currStrOff += strLen_7;
                ...
                cats =  cats->add(cats, rope(____BAH_COMPILER_VAR_333));
};
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_334+currStrOff, lens, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_334+currStrOff, ";                            \n                    ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_334+currStrOff, rstr, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_334+currStrOff, " = memoryAllocSTR(", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_334+currStrOff, totStrLen, strLen_5);
                    currStrOff += strLen_5;
                ...
                struct rope* res =  rope(____BAH_COMPILER_VAR_334)->add(rope(____BAH_COMPILER_VAR_334), cats)->add(rope(____BAH_COMPILER_VAR_334)->add(rope(____BAH_COMPILER_VAR_334), cats), rope("\n                }\n                "));
if (isGlobal()) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_335+currStrOff, "add(", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_336+currStrOff, "sub(", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_337+currStrOff, "mult(", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_338+currStrOff, sep, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_338+currStrOff, "div(", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_338+currStrOff, amp, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_338+currStrOff, pt.cont, strLen_4);
                    currStrOff += strLen_4;
                    ...
                    memcpy(____BAH_COMPILER_VAR_338+currStrOff, ")", strLen_7);
                    currStrOff += strLen_7;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_339+currStrOff, "Undefined operation on {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_339+currStrOff, ptt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_339+currStrOff, ").", strLen_2);
                    currStrOff += strLen_2;
                    
                }
                throwErr(&pt,____BAH_COMPILER_VAR_339);
}
}
else {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_340+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_340+currStrOff, " ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_340+currStrOff, nt.cont, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_341+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_341+currStrOff, ntt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_341+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_341+currStrOff, ptt, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_341+currStrOff, ".", strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_342+currStrOff, pt.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_342+currStrOff, t.cont, strLen_1);
                    currStrOff += strLen_1;
...
i =  i+1;
struct Tok ____BAH_COMPILER_VAR_343 = {};
____BAH_COMPILER_VAR_343.cont = "";
____BAH_COMPILER_VAR_343.ogCont = "";
____BAH_COMPILER_VAR_343.type = TOKEN_NO_TYPE;
____BAH_COMPILER_VAR_343.pos = 0;
____BAH_COMPILER_VAR_343.line = 1;
____BAH_COMPILER_VAR_343.begLine = 1;
____BAH_COMPILER_VAR_343.bahType = "";
____BAH_COMPILER_VAR_343.isValue = false;
____BAH_COMPILER_VAR_343.isFunc = false;
____BAH_COMPILER_VAR_343.isOper = false;
____BAH_COMPILER_VAR_343.cont = "";
struct Tok nt =  ____BAH_COMPILER_VAR_343;
if ((i<len(line))) {
...
char * ____BAH_COMPILER_VAR_346 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_347 =structType.str((struct string*)&structType);char * ____BAH_COMPILER_VAR_348 =declareStructMethods(tmpV,s,elems);char * ____BAH_COMPILER_VAR_349 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, ____BAH_COMPILER_VAR_346, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, " = memoryAlloc(sizeof(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, ____BAH_COMPILER_VAR_347, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, "));\n", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_349+currStrOff, ____BAH_COMPILER_VAR_348, strLen_6);
                    currStrOff += strLen_6;
...
____BAH_COMPILER_VAR_350->isGlobal = false;
struct variable* tmpV =  ____BAH_COMPILER_VAR_350;
tmpV->name =  rvn;
if ((isHeap==true)) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_351+currStrOff, s->name, strLen_0);
                    currStrOff += strLen_0;
                ...
                tmpV->type =  ____BAH_COMPILER_VAR_351;
...
struct rope* r= null;
if ((isHeap==true)) {
char * ____BAH_COMPILER_VAR_352 =rst.str((struct string*)&rst);struct string structType =  string(____BAH_COMPILER_VAR_352);
structType.trimRight((struct string*)&structType,1);
char * ____BAH_COMPILER_VAR_353 =rst.str((struct string*)&rst);char * ____BAH_COMPILER_VAR_354 =structType.str((struct string*)&structType);char * ____BAH_COMPILER_VAR_355 =declareStructMethods(tmpV,s,elems);char * ____BAH_COMPILER_VAR_356 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_5 = strlen("));\n");
long int strLen_6 = strlen(____BAH_COMPILER_VAR_355);
;                            
                    ____BAH_COMPILER_VAR_356 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6);
                    
                    memcpy(____BAH_COMPILER_VAR_356+currStrOff, ____BAH_COMPILER_VAR_353, strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_356+currStrOff, ____BAH_COMPILER_VAR_354, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_356+currStrOff, "));\n", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_356+currStrOff, ____BAH_COMPILER_VAR_355, strLen_6);
                    currStrOff += strLen_6;
...
char * ____BAH_COMPILER_VAR_357 =rst.str((struct string*)&rst);char * ____BAH_COMPILER_VAR_358 =declareStructMethods(tmpV,s,elems);char * ____BAH_COMPILER_VAR_359 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_2 = strlen(rvn);
long int strLen_3 = strlen(" = {};\n");
long int strLen_4 = strlen(____BAH_COMPILER_VAR_358);
;                            
                    ____BAH_COMPILER_VAR_359 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4);
                    
                    memcpy(____BAH_COMPILER_VAR_359+currStrOff, ____BAH_COMPILER_VAR_357, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_359+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_359+currStrOff, rvn, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_359+currStrOff, " = {};\n", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_359+currStrOff, ____BAH_COMPILER_VAR_358, strLen_4);
                    currStrOff += strLen_4;
                    
                }
                r =  rope(____BAH_COMPILER_VAR_359);
}
long int j =  0;
long int k =  0;
while ((k<len(memory))) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_360+currStrOff, vlt, strLen_1);
                    currStrOff += strLen_1;
                ...
                throwErr(&vl,____BAH_COMPILER_VAR_360);
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_361+currStrOff, vl.cont, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_362+currStrOff, "Struct '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_362+currStrOff, s->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_362+currStrOff, "' has no member called {TOKEN}.", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_363+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_363+currStrOff, ") as '", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_363+currStrOff, m->type, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_364+currStrOff, rvn, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_364+currStrOff, sep, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_364+currStrOff, m->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_364+currStrOff, " = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_364+currStrOff, t.cont, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_365+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_365+currStrOff, v->type, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_365+currStrOff, ") as a structure.", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_366+currStrOff, t.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_366+currStrOff, sep, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_366+currStrOff, memb->name, strLen_2);
                    currStrOff += strLen_2;
                    
                }
                t.cont =  ____BAH_COMPILER_VAR_366;
i =  i+1;
};
...
;                            
                ...
                bracks =  ____BAH_COMPILER_VAR_367;
i =  i+1;
}
else {
break;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_368+currStrOff, arrElem, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                t.bahType =  ____BAH_COMPILER_VAR_368;
t.cont =  "";
t.isValue =  true;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_369+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_369+currStrOff, ntt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_369+currStrOff, ") as an array.", strLen_2);
                    currStrOff += strLen_2;
...
char * ____BAH_COMPILER_VAR_370 =arrT.str((struct string*)&arrT);if ((compTypes(ptt,____BAH_COMPILER_VAR_370)==false)) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_371+currStrOff, "Cannot search for {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_371+currStrOff, ptt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_371+currStrOff, ") inside array of type ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_371+currStrOff, ntt, strLen_3);
                    currStrOff += strLen_3;
                ...
                throwErr(&pt,____BAH_COMPILER_VAR_371);
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_372+currStrOff, "->data[i] != 0 && strcmp(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_372+currStrOff, nt.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_372+currStrOff, "->data[i], ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_372+currStrOff, pt.cont, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_372+currStrOff, ") == 0", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_373+currStrOff, nt.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_373+currStrOff, "->data[i] == ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_373+currStrOff, pt.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                }
                comp =  ____BAH_COMPILER_VAR_373;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, compVar, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, " = 0;\n                for(int i=len(", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, nt.cont, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, ")-1; i != -1; i--) {\n                    if (", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, comp, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, ") {\n                        ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, compVar, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_374+currStrOff, " = 1;\n                        break;\n                    };\n                };\n                ", strLen_8);
                    currStrOff += strLen_8;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_375+currStrOff, "Cannot compare {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_375+currStrOff, ntt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_375+currStrOff, ") to ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_375+currStrOff, ptt, strLen_3);
                    currStrOff += strLen_3;
                ...
                throwErr(&nt,____BAH_COMPILER_VAR_375);
}
if ((strcmp(ptt, "cpstring") == 0)) {
if ((strcmp(t.cont, "==") == 0)) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_377+currStrOff, "(strcmp(", strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_377+currStrOff, ") != 0)", strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_381+currStrOff, "(strlen(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_381+currStrOff, pt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_381+currStrOff, ") <= srtlen(", strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_383+currStrOff, pt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_383+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_383+currStrOff, nt.cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_387+currStrOff, cont, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_388+currStrOff, from, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_390+currStrOff, to, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_390+currStrOff, mt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                to =  ____BAH_COMPILER_VAR_390;
};
}
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_391+currStrOff, "cpstringCharAt(", strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_391+currStrOff, cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_392+currStrOff, "cpstringSubsitute(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_392+currStrOff, lt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_392+currStrOff, ", ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_392+currStrOff, from, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_392+currStrOff, ", ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_392+currStrOff, to, strLen_5);
                    currStrOff += strLen_5;
...
____BAH_COMPILER_VAR_393->isGlobal = false;
____BAH_COMPILER_VAR_393->name = genCompilerVar();
____BAH_COMPILER_VAR_393->type = tt;
struct variable* tmpV =  ____BAH_COMPILER_VAR_393;
...
;                            
                ...
                INIT =  INIT->add(INIT, rope(____BAH_COMPILER_VAR_395));
}
else {
char * ____BAH_COMPILER_VAR_396 =elemType.str((struct string*)&elemType);char * ____BAH_COMPILER_VAR_397 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_397+currStrOff, ____BAH_COMPILER_VAR_396, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_397+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_397+currStrOff, tmpV->name, strLen_2);
                    currStrOff += strLen_2;
...
long int strLen_7 = strlen(");\n");
;                            
                    ____BAH_COMPILER_VAR_398 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7);
                    
                    memcpy(____BAH_COMPILER_VAR_398+currStrOff, lt.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_398+currStrOff, "->set(", strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_399+currStrOff, "->setAny(", strLen_1);
                    currStrOff += strLen_1;
                    ...
                    memcpy(____BAH_COMPILER_VAR_399+currStrOff, tmpV->name, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_399+currStrOff, ", sizeof(", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_399+currStrOff, tmpV->name, strLen_8);
                    currStrOff += strLen_8;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_400+currStrOff, lt.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_400+currStrOff, "->get(", strLen_1);
                    currStrOff += strLen_1;
                    ...
                    memcpy(____BAH_COMPILER_VAR_400+currStrOff, cont, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_400+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
char * ____BAH_COMPILER_VAR_401 =elemType.str((struct string*)&elemType);char * ____BAH_COMPILER_VAR_402 =intToStr(lt.line);char * ____BAH_COMPILER_VAR_403 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ____BAH_COMPILER_VAR_403 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10 + strLen_11 + strLen_12 + strLen_13 + strLen_14 + strLen_15 + strLen_16 + strLen_17 + strLen_18 + strLen_19);
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, ____BAH_COMPILER_VAR_401, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, "* ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, tmpV, strLen_2);
                    currStrOff += strLen_2;
                    ...
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, "->get(", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, lt.cont, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, ", ", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, cont, strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, ");\n                        if(", strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, tmpV, strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, " == null) {\n                            printf(\"map (", strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, compilerState.currentFile, strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, ":", strLen_13);
                    currStrOff += strLen_13;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, ____BAH_COMPILER_VAR_402, strLen_14);
                    currStrOff += strLen_14;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, "): ", strLen_15);
                    currStrOff += strLen_15;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, lt.cont, strLen_16);
                    currStrOff += strLen_16;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, "[\\\"%s\\\"] does not exist\\n\", ", strLen_17);
                    currStrOff += strLen_17;
                    
                    memcpy(____BAH_COMPILER_VAR_403+currStrOff, cont, strLen_18);
                ...
                struct rope* res =  rope(____BAH_COMPILER_VAR_403);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_405+currStrOff, ____BAH_COMPILER_VAR_404, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_405+currStrOff, ")(*", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_405+currStrOff, tmpV, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_407+currStrOff, cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_407+currStrOff, " >= ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_407+currStrOff, amm, strLen_3);
                    currStrOff += strLen_3;
                    ...
                    memcpy(____BAH_COMPILER_VAR_407+currStrOff, amm, strLen_13);
                    currStrOff += strLen_13;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_409+currStrOff, "cpstringSubsitute(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_409+currStrOff, lt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_409+currStrOff, ", ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_409+currStrOff, from, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_409+currStrOff, ", ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_409+currStrOff, to, strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_410+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_410+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_410+currStrOff, ") as an array.", strLen_2);
                    currStrOff += strLen_2;
                    
                }
                throwErr(&lt,____BAH_COMPILER_VAR_410);
}
strTrimLeft(&tt,2);
if ((split==false)) {
if (((ti>0)&&(strcmp(ft.cont, "else") != 0))) {
char * ____BAH_COMPILER_VAR_411 =intToStr(lt.line);char * ____BAH_COMPILER_VAR_412 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("\n                    if (");
long int strLen_1 = strlen(lt.cont);
...
long int strLen_12 = strlen(":");
long int strLen_13 = strlen(____BAH_COMPILER_VAR_411);
long int strLen_14 = strlen("\");\n                    };\n                    ");
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, lt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, "->length <= ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, cont, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, ") {\n                        char buff[300];\n                        snprintf(buff, 299, \"array: ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, lt.cont, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, "[%d] with length %d\", ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, cont, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, ", ", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, lt.cont, strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, "->length);\n                        __BAH_panic(buff, \"", strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, compilerState.currentFile, strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, ":", strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_412+currStrOff, ____BAH_COMPILER_VAR_411, strLen_13);
                    currStrOff += strLen_13;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_413+currStrOff, lt.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_413+currStrOff, "->data[", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_413+currStrOff, cont, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_414+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                lt.bahType =  ____BAH_COMPILER_VAR_414;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_415+currStrOff, "arraySubstitute(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_415+currStrOff, lt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_415+currStrOff, ", ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_415+currStrOff, from, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_415+currStrOff, ", ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_415+currStrOff, to, strLen_5);
                    currStrOff += strLen_5;
...
char * code= null;
if ((ptrLevel==0)) {
char * ____BAH_COMPILER_VAR_416 =svt.str((struct string*)&svt);char * ____BAH_COMPILER_VAR_417 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_4 = strlen(____BAH_COMPILER_VAR_416);
long int strLen_5 = strlen(")");
;                            
                    ____BAH_COMPILER_VAR_417 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5);
                    
                    memcpy(____BAH_COMPILER_VAR_417+currStrOff, "__serialize(&", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_417+currStrOff, e.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_417+currStrOff, ", ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_417+currStrOff, "sizeof(struct ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_417+currStrOff, ____BAH_COMPILER_VAR_416, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_417+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_418+currStrOff, ptrRect, strLen_0);
                    currStrOff += strLen_0;
                ...
                ptrRect =  ____BAH_COMPILER_VAR_418;
ptrLevel =  ptrLevel - 1;
};
char * ____BAH_COMPILER_VAR_419 =svt.str((struct string*)&svt);char * ____BAH_COMPILER_VAR_420 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("__serialize(");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_420+currStrOff, "__serialize(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_420+currStrOff, ptrRect, strLen_1);
                    currStrOff += strLen_1;
                    ...
                    memcpy(____BAH_COMPILER_VAR_420+currStrOff, "sizeof(struct ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_420+currStrOff, ____BAH_COMPILER_VAR_419, strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_421+currStrOff, "+strlen(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_421+currStrOff, e.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_421+currStrOff, "->", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_421+currStrOff, m->name, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_421+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_424+currStrOff, ____BAH_COMPILER_VAR_423, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_424+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_424+currStrOff, v, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_424+currStrOff, " = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_424+currStrOff, t.cont, strLen_4);
                    currStrOff += strLen_4;
...
tmpT.cont =  "0";
char * ____BAH_COMPILER_VAR_426 =aet.str((struct string*)&aet);struct Tok rt =  parseReflect(tmpT,____BAH_COMPILER_VAR_426,elems,true,"","0");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_427+currStrOff, rt.cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_428+currStrOff, aev, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                arrElem =  ____BAH_COMPILER_VAR_428;
}
...
tmpT.type =  TOKEN_TYPE_VAR;
tmpT.cont =  "0";
char * ____BAH_COMPILER_VAR_430 =aet.str((struct string*)&aet);struct Tok rt =  parseReflect(tmpT,____BAH_COMPILER_VAR_430,elems,true,"","0");
char * aev =  genCompilerVar();
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_431+currStrOff, rt.cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_432+currStrOff, aev, strLen_1);
                    currStrOff += strLen_1;
...
struct variable* slv =  ____BAH_COMPILER_VAR_433;
...
struct structMemb* ____BAH_COMPILER_VAR_434 = memoryAlloc(sizeof(struct structMemb));
...
____BAH_COMPILER_VAR_434->def = "";
____BAH_COMPILER_VAR_434->isFn = false;
struct structMemb* nm =  ____BAH_COMPILER_VAR_434;
*nm =  *m;
m =  nm;
m->type =  "ptr";
}
...
char * ____BAH_COMPILER_VAR_436 =mCtype.str((struct string*)&mCtype);char * ____BAH_COMPILER_VAR_437 =offsetTT.str((struct string*)&offsetTT);char * ____BAH_COMPILER_VAR_438 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("(");
...
long int strLen_5 = strlen(____BAH_COMPILER_VAR_437);
long int strLen_6 = strlen(", ");
long int strLen_7 = strlen(m->name);
long int strLen_8 = strlen("))");
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, ____BAH_COMPILER_VAR_436, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, "*)((char*)(", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, t.cont, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, ") + offsetof(struct ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, ____BAH_COMPILER_VAR_437, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, ", ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_438+currStrOff, m->name, strLen_7);
                    currStrOff += strLen_7;
                ...
                tmpT.cont =  ____BAH_COMPILER_VAR_438;
char * ____BAH_COMPILER_VAR_439 =offsetTT.str((struct string*)&offsetTT);char * ____BAH_COMPILER_VAR_440 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_440+currStrOff, "offsetof(struct ", strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_440+currStrOff, m->name, strLen_3);
                    currStrOff += strLen_3;
                ...
                struct Tok rt =  parseReflect(tmpT,m->type,elems,true,m->name,____BAH_COMPILER_VAR_440);
char * ____BAH_COMPILER_VAR_441 =intToStr(i);char * ____BAH_COMPILER_VAR_442 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_442+currStrOff, structLayout, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_442+currStrOff, "->data[", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_442+currStrOff, ____BAH_COMPILER_VAR_441, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_442+currStrOff, "] = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_442+currStrOff, rt.cont, strLen_4);
                    currStrOff += strLen_4;
                ...
                dataLayout =  dataLayout->add(dataLayout, rope(____BAH_COMPILER_VAR_442));
};
char * ____BAH_COMPILER_VAR_443 =intToStr(len(ts->members));char * ____BAH_COMPILER_VAR_444 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_7 = strlen(____BAH_COMPILER_VAR_443);
long int strLen_8 = strlen(";\n        ");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, structLayout, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, " = memoryAlloc(sizeof(array(struct reflectElement)));\n        ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, structLayout, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, "->elemSize = sizeof(struct reflectElement);\n        ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, structLayout, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, "->length = ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, ____BAH_COMPILER_VAR_443, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, ";\n        ", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, structLayout, strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, "->data = memoryAlloc(", strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, structLayout, strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, "->length * ", strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, structLayout, strLen_13);
                    currStrOff += strLen_13;
                    
                    memcpy(____BAH_COMPILER_VAR_444+currStrOff, "->elemSize);\n        ", strLen_14);
                    currStrOff += strLen_14;
                    
                }
                OUTPUT =  OUTPUT->add(OUTPUT, rope(____BAH_COMPILER_VAR_444))->add(OUTPUT->add(OUTPUT, rope(____BAH_COMPILER_VAR_444)), dataLayout);
}
char * amp =  "";
...
struct variable* rv =  ____BAH_COMPILER_VAR_445;
...
char * ____BAH_COMPILER_VAR_446 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_447 =name.str((struct string*)&name);char * ____BAH_COMPILER_VAR_448 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_6 = strlen(____BAH_COMPILER_VAR_446);
long int strLen_7 = strlen("), \"");
...
;                            
                    ____BAH_COMPILER_VAR_448 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10 + strLen_11 + strLen_12 + strLen_13 + strLen_14 + strLen_15 + strLen_16 + strLen_17 + strLen_18 + strLen_19 + strLen_20 + strLen_21);
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, "struct reflectElement ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, rv->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, " = __reflect(", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, amp, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, t.cont, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ", sizeof(", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ____BAH_COMPILER_VAR_446, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, "), \"", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, tt, strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, "\", \"", strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ____BAH_COMPILER_VAR_447, strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, "\", ", strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, isArr, strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ", ", strLen_13);
                    currStrOff += strLen_13;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, arrElem, strLen_14);
                    currStrOff += strLen_14;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ", ", strLen_15);
                    currStrOff += strLen_15;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, isStruct, strLen_16);
                    currStrOff += strLen_16;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ", ", strLen_17);
                    currStrOff += strLen_17;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, structLayout, strLen_18);
                    currStrOff += strLen_18;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, ", ", strLen_19);
                    currStrOff += strLen_19;
                    
                    memcpy(____BAH_COMPILER_VAR_448+currStrOff, offset, strLen_20);
                ...
                OUTPUT =  OUTPUT->add(OUTPUT, rope(____BAH_COMPILER_VAR_448));
t.cont =  rv->name;
return t;
};
...
char * ____BAH_COMPILER_VAR_449 =fnarg1t.str((struct string*)&fnarg1t);char * ____BAH_COMPILER_VAR_450 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("(");
...
;                            
                ...
                varName.prepend((struct string*)&varName,____BAH_COMPILER_VAR_450);
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_451+currStrOff, fnName, strLen_0);
                    currStrOff += strLen_0;
...
struct Tok tk =  ____BAH_COMPILER_VAR_452;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_454+currStrOff, ot.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_454+currStrOff, t.cont, strLen_1);
                    currStrOff += strLen_1;
...
memory->data[len(memory)-1] =  ____BAH_COMPILER_VAR_457;
memory->length = nLength+1;
} else {
memory->data[len(memory)-1] =  ____BAH_COMPILER_VAR_457;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_459+currStrOff, fnName, strLen_0);
                    currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_460 =intToStr(ot.line);char * ____BAH_COMPILER_VAR_461 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("\"");
long int strLen_1 = strlen(compilerState.currentFile);
long int strLen_2 = strlen(":");
long int strLen_3 = strlen(____BAH_COMPILER_VAR_460);
long int strLen_4 = strlen("\"");
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_461+currStrOff, compilerState.currentFile, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_461+currStrOff, ":", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_461+currStrOff, ____BAH_COMPILER_VAR_460, strLen_3);
                    currStrOff += strLen_3;
...
____BAH_COMPILER_VAR_462->name = genCompilerVar();
____BAH_COMPILER_VAR_462->type = "[]reflectElement";
____BAH_COMPILER_VAR_462->isArray = true;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_463+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                vname =  ____BAH_COMPILER_VAR_463;
}
...
____BAH_COMPILER_VAR_464.cont = vname;
____BAH_COMPILER_VAR_464.bahType = v->type;
____BAH_COMPILER_VAR_464.isValue = true;
struct Tok tmpT =  ____BAH_COMPILER_VAR_464;
tmpT =  parseReflect(tmpT,v->type,elems,true,v->name,"0");
char * ____BAH_COMPILER_VAR_465 =intToStr(j);char * ____BAH_COMPILER_VAR_466 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_466+currStrOff, tmpV->name, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_466+currStrOff, "->data[", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_466+currStrOff, ____BAH_COMPILER_VAR_465, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_466+currStrOff, "] = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_466+currStrOff, tmpT.cont, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_466+currStrOff, ";\n", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_467+currStrOff, decls, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_467+currStrOff, ____BAH_COMPILER_VAR_466, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                decls =  ____BAH_COMPILER_VAR_467;
};
char * ____BAH_COMPILER_VAR_468 =intToStr(len(symbols));char * ____BAH_COMPILER_VAR_469 =intToStr(len(symbols));char * ____BAH_COMPILER_VAR_470 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("\n                        array(struct reflectElement)* ");
...
long int strLen_5 = strlen(____BAH_COMPILER_VAR_468);
long int strLen_6 = strlen(");\n                        ");
long int strLen_7 = strlen(tmpV->name);
long int strLen_8 = strlen("->length = ");
long int strLen_9 = strlen(____BAH_COMPILER_VAR_469);
long int strLen_10 = strlen(";\n                        ");
...
long int strLen_14 = strlen("\n                        ");
;                            
                    ____BAH_COMPILER_VAR_470 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10 + strLen_11 + strLen_12 + strLen_13 + strLen_14);
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, "\n                        array(struct reflectElement)* ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, tmpV->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, " = memoryAlloc(sizeof(array(struct reflectElement)));\n                        ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, tmpV->name, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, "->data = memoryAlloc(sizeof(struct reflectElement) * ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, ____BAH_COMPILER_VAR_468, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, ");\n                        ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, tmpV->name, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, "->length = ", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, ____BAH_COMPILER_VAR_469, strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, ";\n                        ", strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, tmpV->name, strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, "->elemSize = sizeof(struct reflectElement);\n                        ", strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_470+currStrOff, decls, strLen_13);
                    currStrOff += strLen_13;
...
____BAH_COMPILER_VAR_471.cont = tmpV->name;
...
memory->data[0] =  ____BAH_COMPILER_VAR_471;
memory->length = nLength+1;
} else {
memory->data[0] =  ____BAH_COMPILER_VAR_471;
}
...
char * ____BAH_COMPILER_VAR_472 =intToStr(ot.line);char * ____BAH_COMPILER_VAR_473 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("\"");
long int strLen_1 = strlen(compilerState.currentFile);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_473+currStrOff, compilerState.currentFile, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_473+currStrOff, ":", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_473+currStrOff, ____BAH_COMPILER_VAR_472, strLen_3);
                    currStrOff += strLen_3;
                ...
                char * currLine =  ____BAH_COMPILER_VAR_473;
...
____BAH_COMPILER_VAR_474.cont = "__dumpSymbols";
...
memory->length = 3;
memory->elemSize = sizeof(struct Tok);
memory->data = memoryAlloc(sizeof(struct Tok) * 50);memory->data[0] = ____BAH_COMPILER_VAR_474;
memory->data[1] = ____BAH_COMPILER_VAR_475;
memory->data[2] = ____BAH_COMPILER_VAR_476;
...
____BAH_COMPILER_VAR_478.type = TOKEN_TYPE_STR;
____BAH_COMPILER_VAR_478.cont = currLine;
...
memory->data[len(memory)] =  ____BAH_COMPILER_VAR_478;
memory->length = nLength+1;
} else {
memory->data[len(memory)] =  ____BAH_COMPILER_VAR_478;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_479+currStrOff, fnName, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_480+currStrOff, tp, strLen_0);
                    currStrOff += strLen_0;
                ...
                tp =  ____BAH_COMPILER_VAR_480;
};
struct string cType =  getCType(tp,elems);
char * ____BAH_COMPILER_VAR_481 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_482 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_482+currStrOff, ____BAH_COMPILER_VAR_481, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_484+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_484+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_484+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_484+currStrOff, arg->type, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_484+currStrOff, " in function call.", strLen_4);
                    currStrOff += strLen_4;
...
struct string ____BAH_COMPILER_VAR_485 =string(t.cont);char * afnName =  splitStringBefore(____BAH_COMPILER_VAR_485,"(");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_488+currStrOff, ot.cont, strLen_0);
                    currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_489 =arrType.str((struct string*)&arrType);char * ____BAH_COMPILER_VAR_490 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_490+currStrOff, "memoryAlloc(sizeof(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_490+currStrOff, ____BAH_COMPILER_VAR_489, strLen_1);
                    currStrOff += strLen_1;
                ...
                char * code =  ____BAH_COMPILER_VAR_490;
...
char * ____BAH_COMPILER_VAR_492 =elemType.str((struct string*)&elemType);struct string cType =  getCType(____BAH_COMPILER_VAR_492,elems);
char * ____BAH_COMPILER_VAR_493 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_494 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("\n                array(");
...
long int strLen_8 = strlen("\n                ");
;                            
                    ____BAH_COMPILER_VAR_494 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8);
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, "\n                array(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, ____BAH_COMPILER_VAR_493, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, ") * ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, tmpV->name, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, " = ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, innerCode, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, ";\n                ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_494+currStrOff, NEXT_LINE, strLen_7);
                    currStrOff += strLen_7;
                ...
                OUTPUT =  OUTPUT->add(OUTPUT, rope(____BAH_COMPILER_VAR_494));
NEXT_LINE =  oldNL;
...
____BAH_COMPILER_VAR_495.type = TOKEN_TYPE_VAR;
____BAH_COMPILER_VAR_495.cont = tmpV->name;
____BAH_COMPILER_VAR_495.bahType = elemType.str((struct string*)&elemType);
____BAH_COMPILER_VAR_495.isValue = true;
t =  ____BAH_COMPILER_VAR_495;
}
char * tt =  getTypeFromToken(&t,true,elems);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_496+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_496+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_496+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_496+currStrOff, elemBahTypeStr, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_497+currStrOff, NEXT_LINE, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_497+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_497+currStrOff, "->data[", strLen_2);
                    currStrOff += strLen_2;
                    ...
                    memcpy(____BAH_COMPILER_VAR_497+currStrOff, t.cont, strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ____BAH_COMPILER_VAR_498 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6);
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, v->name, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, "->data = memoryAlloc(sizeof(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, elemTypeStr, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, ") * ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, allocLengthStr, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, ");", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_498+currStrOff, NEXT_LINE, strLen_6);
                    currStrOff += strLen_6;
...
;                            
                    ____BAH_COMPILER_VAR_499 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9);
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, "\n", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, "->length = ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, strArrayLength, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, ";\n", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, v->name, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, "->elemSize = sizeof(", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, elemTypeStr, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, ");\n", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_499+currStrOff, NEXT_LINE, strLen_9);
                    currStrOff += strLen_9;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_502+currStrOff, "Cannot use '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_502+currStrOff, lt.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_502+currStrOff, "' on non declared {TOKEN} variable.", strLen_2);
                    currStrOff += strLen_2;
                    
                }
                throwErr(&ft,____BAH_COMPILER_VAR_502);
}
array(struct Tok)* nl = memoryAlloc(sizeof(array(struct Tok)));
...
struct Tok ____BAH_COMPILER_VAR_503 = {};
____BAH_COMPILER_VAR_503.cont = "";
____BAH_COMPILER_VAR_503.ogCont = "";
____BAH_COMPILER_VAR_503.type = TOKEN_NO_TYPE;
____BAH_COMPILER_VAR_503.pos = 0;
____BAH_COMPILER_VAR_503.line = 1;
____BAH_COMPILER_VAR_503.begLine = 1;
____BAH_COMPILER_VAR_503.bahType = "";
____BAH_COMPILER_VAR_503.isValue = false;
____BAH_COMPILER_VAR_503.isFunc = false;
____BAH_COMPILER_VAR_503.isOper = false;
____BAH_COMPILER_VAR_503.type = TOKEN_TYPE_SYNTAX;
____BAH_COMPILER_VAR_503.cont = "=";
____BAH_COMPILER_VAR_503.isValue = false;
...
nl->data[1] =  ____BAH_COMPILER_VAR_503;
nl->length = nLength+1;
} else {
nl->data[1] =  ____BAH_COMPILER_VAR_503;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_505+currStrOff, ft.cont, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_505+currStrOff, "-1", strLen_1);
                    currStrOff += strLen_1;
                    
                }
                c =  ____BAH_COMPILER_VAR_505;
}
long int ltl =  lt.line;
long int ltp =  lt.pos;
char * ltc =  lt.cont;
struct Tok ____BAH_COMPILER_VAR_506 = {};
____BAH_COMPILER_VAR_506.cont = "";
____BAH_COMPILER_VAR_506.ogCont = "";
____BAH_COMPILER_VAR_506.type = TOKEN_NO_TYPE;
____BAH_COMPILER_VAR_506.pos = 0;
____BAH_COMPILER_VAR_506.line = 1;
____BAH_COMPILER_VAR_506.begLine = 1;
____BAH_COMPILER_VAR_506.bahType = "";
____BAH_COMPILER_VAR_506.isValue = false;
____BAH_COMPILER_VAR_506.isFunc = false;
____BAH_COMPILER_VAR_506.isOper = false;
____BAH_COMPILER_VAR_506.type = TOKEN_TYPE_INT;
____BAH_COMPILER_VAR_506.cont = c;
____BAH_COMPILER_VAR_506.line = ltl;
____BAH_COMPILER_VAR_506.ogCont = ltc;
____BAH_COMPILER_VAR_506.pos = ltp;
____BAH_COMPILER_VAR_506.isOper = true;
____BAH_COMPILER_VAR_506.isValue = true;
...
nl->data[2] =  ____BAH_COMPILER_VAR_506;
nl->length = nLength+1;
} else {
nl->data[2] =  ____BAH_COMPILER_VAR_506;
}
...
throwErr(&ft,"Missing '=' after {TOKEN}.");
                ...
                int ____BAH_COMPILER_VAR_507 = 0;
                for(int i=len(equalsTokens)-1; i != -1; i--) {
                    if (equalsTokens->data[i] != 0 && strcmp(equalsTokens->data[i], operT.cont) == 0) {
                        ____BAH_COMPILER_VAR_507 = 1;
                        break;
                    };
                };
                if ((____BAH_COMPILER_VAR_507&&(strcmp(operT.cont, "=") != 0))) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_508+currStrOff, currentType, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_508+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_508+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                }
                currentType =  ____BAH_COMPILER_VAR_508;
}
else {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_509+currStrOff, "chan:", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_510+currStrOff, "map:", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_511+currStrOff, "buffer:", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_511+currStrOff, nt.cont, strLen_1);
                    currStrOff += strLen_1;
...
struct variable* av =  ____BAH_COMPILER_VAR_512;
av->type =  "char*";
av->name =  genCompilerVar();
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_513+currStrOff, "char ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_513+currStrOff, av->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_513+currStrOff, "[", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_513+currStrOff, nt.cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_515+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_515+currStrOff, tp, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_515+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_515+currStrOff, v->type, strLen_3);
                    currStrOff += strLen_3;
                ...
                throwErr(&t,____BAH_COMPILER_VAR_515);
}
}
}
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_516+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_517+currStrOff, "; RCP_incrCounter(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_517+currStrOff, iv->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_517+currStrOff, ".__RCP_counter)", strLen_3);
                    currStrOff += strLen_3;
...
char * ____BAH_COMPILER_VAR_518 =ivn.str((struct string*)&ivn);char * ____BAH_COMPILER_VAR_519 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(code);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_519+currStrOff, "; RCP_incr(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_519+currStrOff, ____BAH_COMPILER_VAR_518, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_520+currStrOff, code, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_520+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_520+currStrOff, t.cont, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_521+currStrOff, "Cannot change the type of already declared var '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_521+currStrOff, ft.cont, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_521+currStrOff, "' to {TOKEN}.", strLen_2);
                    currStrOff += strLen_2;
                    
                }
                throwErr(&st,____BAH_COMPILER_VAR_521);
}
if ((isStruct==false)) {
...
char * ____BAH_COMPILER_VAR_522 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_523 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_524 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("*(");
...
long int strLen_3 = strlen(v->name);
long int strLen_4 = strlen(") = *(");
long int strLen_5 = strlen(____BAH_COMPILER_VAR_523);
long int strLen_6 = strlen("*)RCP_incrIL(&");
long int strLen_7 = strlen(code);
long int strLen_8 = strlen(")");
;                            
                    ____BAH_COMPILER_VAR_524 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8);
                    
                    memcpy(____BAH_COMPILER_VAR_524+currStrOff, "*(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_524+currStrOff, ____BAH_COMPILER_VAR_522, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_524+currStrOff, "*)RCP_decrIL(&", strLen_2);
                    currStrOff += strLen_2;
                    ...
                    memcpy(____BAH_COMPILER_VAR_524+currStrOff, ____BAH_COMPILER_VAR_523, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_524+currStrOff, "*)RCP_incrIL(&", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_524+currStrOff, code, strLen_7);
                    currStrOff += strLen_7;
...
char * ____BAH_COMPILER_VAR_526 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_527 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_528 =dv->toStr((struct rope*)dv);char * ____BAH_COMPILER_VAR_529 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_7 = strlen(" = *(");
long int strLen_8 = strlen(____BAH_COMPILER_VAR_527);
long int strLen_9 = strlen("*)RCP_incrIL(&");
long int strLen_10 = strlen(code);
long int strLen_11 = strlen(");");
long int strLen_12 = strlen(____BAH_COMPILER_VAR_528);
;                            
                    ____BAH_COMPILER_VAR_529 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10 + strLen_11 + strLen_12);
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, ____BAH_COMPILER_VAR_526, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, tmpV->name, strLen_2);
                    currStrOff += strLen_2;
                    ...
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, v->name, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, " = *(", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, ____BAH_COMPILER_VAR_527, strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, "*)RCP_incrIL(&", strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, code, strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, ");", strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_529+currStrOff, ____BAH_COMPILER_VAR_528, strLen_12);
                    currStrOff += strLen_12;
...
struct variable* ____BAH_COMPILER_VAR_530 = memoryAlloc(sizeof(struct variable));
____BAH_COMPILER_VAR_530->name = "";
____BAH_COMPILER_VAR_530->type = "";
____BAH_COMPILER_VAR_530->isConst = false;
____BAH_COMPILER_VAR_530->constVal = "";
____BAH_COMPILER_VAR_530->isArray = false;
____BAH_COMPILER_VAR_530->from = "";
____BAH_COMPILER_VAR_530->outterScope = false;
____BAH_COMPILER_VAR_530->isGlobal = false;
struct variable* tmpV =  ____BAH_COMPILER_VAR_530;
tmpV->name =  genCompilerVar();
tmpV->type =  v->type;
struct rope* dv =  decrVar(tmpV,elems);
char * ____BAH_COMPILER_VAR_531 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_532 =dv->toStr((struct rope*)dv);char * ____BAH_COMPILER_VAR_533 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_9 = strlen(";");
long int strLen_10 = strlen(____BAH_COMPILER_VAR_532);
;                            
                    ____BAH_COMPILER_VAR_533 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10);
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, ____BAH_COMPILER_VAR_531, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, tmpV->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, " = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, v->name, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, "; ", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, v->name, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, " = ", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, code, strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, ";", strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_533+currStrOff, ____BAH_COMPILER_VAR_532, strLen_10);
                    currStrOff += strLen_10;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_534+currStrOff, "RCP_decrCounter(", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_534+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_534+currStrOff, ".__RCP_counter); ", strLen_2);
                    currStrOff += strLen_2;
                    ...
                    memcpy(____BAH_COMPILER_VAR_534+currStrOff, code, strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_536+currStrOff, v->name, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_536+currStrOff, " = ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_536+currStrOff, code, strLen_2);
                    currStrOff += strLen_2;
...
long int strLen_16 = strlen(";\n}\n}");
;                            
                    ____BAH_COMPILER_VAR_537 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10 + strLen_11 + strLen_12 + strLen_13 + strLen_14 + strLen_15 + strLen_16);
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, "\n{\nlong nLength = ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, nLengthStr, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, ";\nif (", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, nstr, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, "->length < nLength+1) {\nif ((nLength+1) % 50 == 0 || nLength == 0) {\nvoid * newPtr = memoryRealloc(", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, nstr, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, "->data, (nLength+50)*sizeof(", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, elemTypeStr, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, "));\n", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, nstr, strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, "->data = newPtr;\n}\n", strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, code, strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, ";\n", strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, nstr, strLen_13);
                    currStrOff += strLen_13;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, "->length = nLength+1;\n} else {\n", strLen_14);
                    currStrOff += strLen_14;
                    
                    memcpy(____BAH_COMPILER_VAR_537+currStrOff, code, strLen_15);
                    currStrOff += strLen_15;
...
char * ____BAH_COMPILER_VAR_538 =ct.str((struct string*)&ct);char * ____BAH_COMPILER_VAR_539 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_539+currStrOff, ____BAH_COMPILER_VAR_538, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_541 =tmpfnRetCType.str((struct string*)&tmpfnRetCType);char * ____BAH_COMPILER_VAR_542 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_542+currStrOff, ____BAH_COMPILER_VAR_541, strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_542+currStrOff, ")(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_542+currStrOff, tmpfnArgsCType, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_542+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
                    
                }
                vct =  ____BAH_COMPILER_VAR_542;
}
else {
...
long int strLen_1 = strlen(" = *(");
long int strLen_2 = strlen(____BAH_COMPILER_VAR_545);
long int strLen_3 = strlen("*)RCP_incrIL(&");
long int strLen_4 = strlen(code);
long int strLen_5 = strlen(")");
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_546+currStrOff, ____BAH_COMPILER_VAR_545, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_546+currStrOff, "*)RCP_incrIL(&", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_546+currStrOff, code, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_546+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_548+currStrOff, code, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_549+currStrOff, "= null", strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_550+currStrOff, "extern ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_550+currStrOff, vct, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_576+currStrOff, ____BAH_COMPILER_VAR_575, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_576+currStrOff, " (*", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_576+currStrOff, elemName, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_576+currStrOff, ")(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_576+currStrOff, tmpfnArgsCType, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_576+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_577+currStrOff, prev, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_577+currStrOff, ft.cont, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_578+currStrOff, fn->name, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_579+currStrOff, argType, strLen_0);
                    currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_581 =cfrt.str((struct string*)&cfrt);char * ____BAH_COMPILER_VAR_582 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_582+currStrOff, "__BAH_ARR_TYPE_", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_582+currStrOff, ____BAH_COMPILER_VAR_581, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_583 =argCType.str((struct string*)&argCType);char * ____BAH_COMPILER_VAR_584 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(tpdf);
long int strLen_1 = strlen("typedef ");
long int strLen_2 = strlen(____BAH_COMPILER_VAR_583);
long int strLen_3 = strlen(" ");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_584+currStrOff, "typedef ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_584+currStrOff, ____BAH_COMPILER_VAR_583, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_584+currStrOff, " ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_584+currStrOff, newArgType, strLen_4);
                    currStrOff += strLen_4;
...
char * ____BAH_COMPILER_VAR_585 =getCfunctionType(cfrt,argName,elems);char * ____BAH_COMPILER_VAR_586 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(code);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_586+currStrOff, ____BAH_COMPILER_VAR_585, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_587+currStrOff, newArgType, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_587+currStrOff, " ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_587+currStrOff, argName, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_590+currStrOff, code, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_592+currStrOff, returns->type, strLen_0);
                    currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_593 =cfrt.str((struct string*)&cfrt);char * ____BAH_COMPILER_VAR_594 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("__BAH_ARR_TYPE_");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_594+currStrOff, "__BAH_ARR_TYPE_", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_594+currStrOff, ____BAH_COMPILER_VAR_593, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_595 =fnRetType.str((struct string*)&fnRetType);char * ____BAH_COMPILER_VAR_596 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(tpdf);
long int strLen_1 = strlen("typedef ");
long int strLen_2 = strlen(____BAH_COMPILER_VAR_595);
long int strLen_3 = strlen(" ");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_596+currStrOff, "typedef ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_596+currStrOff, ____BAH_COMPILER_VAR_595, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_596+currStrOff, " ", strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_597+currStrOff, tpdf, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_597+currStrOff, newFnRetType, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_597+currStrOff, " ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_597+currStrOff, code, strLen_3);
                    currStrOff += strLen_3;
...
while ((j<len(tmpfn->args))) {
                    ...
                    struct variable* arg =  tmpfn->args->data[j];
struct string ct =  getCType(arg->type,elems);
char * ____BAH_COMPILER_VAR_599 =ct.str((struct string*)&ct);char * ____BAH_COMPILER_VAR_600 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(tmpfnArgsCType);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_600+currStrOff, ____BAH_COMPILER_VAR_599, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_601+currStrOff, tmpfnArgsCType, strLen_0);
                    currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_602 =tmpfnRetCType.str((struct string*)&tmpfnRetCType);char * ____BAH_COMPILER_VAR_603 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(____BAH_COMPILER_VAR_602);
long int strLen_1 = strlen(" (*");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_603+currStrOff, ____BAH_COMPILER_VAR_602, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_603+currStrOff, " (*", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_603+currStrOff, em->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_603+currStrOff, ")(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_603+currStrOff, tmpfnArgsCType, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_603+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_604+currStrOff, emt->name, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_605+currStrOff, a->name, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_608+currStrOff, "__", strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_610+currStrOff, s->name, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_613+currStrOff, "Function '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_613+currStrOff, fn->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_613+currStrOff, "' is not returned.", strLen_2);
                    currStrOff += strLen_2;
...
if ((doesOutput==true)) {
char * ____BAH_COMPILER_VAR_614 =code->toStr((struct rope*)code);char * ____BAH_COMPILER_VAR_615 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_615+currStrOff, nextLine, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_615+currStrOff, ____BAH_COMPILER_VAR_614, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_616+currStrOff, mfn->name, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_617+currStrOff, " ", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_619+currStrOff, mbmType, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_620+currStrOff, "Cannot use {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_620+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_620+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_620+currStrOff, memb->type, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_620+currStrOff, " for member.", strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_622+currStrOff, ____BAH_COMPILER_VAR_621, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_623+currStrOff, tmpfnArgsCType, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_625+currStrOff, ____BAH_COMPILER_VAR_624, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_625+currStrOff, " (*", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_625+currStrOff, memb->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_625+currStrOff, ")(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_625+currStrOff, tmpfnArgsCType, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_625+currStrOff, ")", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_626+currStrOff, memb->name, strLen_1);
                    currStrOff += strLen_1;
                    
                }
                membDecl.append((struct string*)&membDecl,____BAH_COMPILER_VAR_626);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_627+currStrOff, s->name, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_660+currStrOff, tp, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_661+currStrOff, cTypeNewTypeStr, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_661+currStrOff, " ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_661+currStrOff, ft.cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_671+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_671+currStrOff, " ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_671+currStrOff, valt.cont, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_672+currStrOff, "Cannot return nothing as ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_672+currStrOff, currentFn->returns->type, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_673+currStrOff, "Cannot return {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_673+currStrOff, tt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_673+currStrOff, ") as ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_673+currStrOff, currentFn->returns->type, strLen_3);
                    currStrOff += strLen_3;
...
char * ____BAH_COMPILER_VAR_674 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_675 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_675+currStrOff, ____BAH_COMPILER_VAR_674, strLen_0);
                    currStrOff += strLen_0;
                    ...
                    memcpy(____BAH_COMPILER_VAR_675+currStrOff, " = ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_675+currStrOff, rv, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_676+currStrOff, "__STR(", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_677+currStrOff, rvar, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_679 =OUTPUT->toStr((struct rope*)OUTPUT);struct string instC =  string(____BAH_COMPILER_VAR_679);
OUTPUT =  oldOut;
...
char * ____BAH_COMPILER_VAR_680 =instC.str((struct string*)&instC);char * ____BAH_COMPILER_VAR_681 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_681+currStrOff, ____BAH_COMPILER_VAR_680, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_682+currStrOff, condt.cont, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_690 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_691 =intToStr(i);char * ____BAH_COMPILER_VAR_692 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(____BAH_COMPILER_VAR_690);
long int strLen_1 = strlen(" ");
long int strLen_2 = strlen(v);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_692+currStrOff, ____BAH_COMPILER_VAR_690, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_692+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_692+currStrOff, v, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_692+currStrOff, " = fnArgs->data[", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_692+currStrOff, ____BAH_COMPILER_VAR_691, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_692+currStrOff, "];", strLen_5);
                    currStrOff += strLen_5;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_693+currStrOff, ____BAH_COMPILER_VAR_692, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_696+currStrOff, "*", strLen_0);
                    currStrOff += strLen_0;
...
char * ____BAH_COMPILER_VAR_698 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_699 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_700 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_700+currStrOff, ____BAH_COMPILER_VAR_698, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_700+currStrOff, "* r = memoryAlloc(sizeof(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_700+currStrOff, ____BAH_COMPILER_VAR_699, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_700+currStrOff, "));*r = ", strLen_3);
                    currStrOff += strLen_3;
...
char * ____BAH_COMPILER_VAR_701 =intToStr(len(fn->args));char * ____BAH_COMPILER_VAR_702 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, efn->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, "(array(void*)* fnArgs) {\n        if (fnArgs->length != ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, ____BAH_COMPILER_VAR_701, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, ") {\n            __BAH_panic(\"eval: calling function ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, fn->name, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, "() with the wrong number of arguments.\", \"BAH_COMPILER_INTERNAL\");\n        }\n        ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, fnBinding, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, "\n        ", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, setReturnValue, strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_702+currStrOff, fnCall, strLen_10);
                    currStrOff += strLen_10;
...
char * ____BAH_COMPILER_VAR_703 =msg.str((struct string*)&msg);throwWarning(____BAH_COMPILER_VAR_703);
return;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_705+currStrOff, "Could not find file 'eval.bah'. Check your bah directory (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_705+currStrOff, BAH_DIR, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_706 =fnName.str((struct string*)&fnName);struct func* fn =  searchFunc(____BAH_COMPILER_VAR_706,elems,true);
if ((fn==null)) {
char * ____BAH_COMPILER_VAR_707 =fnName.str((struct string*)&fnName);char * ____BAH_COMPILER_VAR_708 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_708+currStrOff, "', arround {TOKEN}.", strLen_2);
                    currStrOff += strLen_2;
...
while ((i<len(fn->args))) {
                    ...
                    struct variable* a =  fn->args->data[i];
struct string cType =  getCType(a->type,elems);
char * ____BAH_COMPILER_VAR_709 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_710 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_710+currStrOff, sMembs, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_710+currStrOff, ____BAH_COMPILER_VAR_709, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_710+currStrOff, " ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_710+currStrOff, a->name, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_711+currStrOff, "args->", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_711+currStrOff, a->name, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_713+currStrOff, sMembs, strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_714 =fnName.str((struct string*)&fnName);char * ____BAH_COMPILER_VAR_715 =sFnT.str((struct string*)&sFnT);char * ____BAH_COMPILER_VAR_716 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen("\n    void ");
...
long int strLen_5 = strlen(____BAH_COMPILER_VAR_714);
long int strLen_6 = strlen("(");
...
long int strLen_12 = strlen(" = {");
long int strLen_13 = strlen(____BAH_COMPILER_VAR_715);
long int strLen_14 = strlen("};\n        pthread_t id;\n        ");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, fnWrapper, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, "(", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, tmpArgsStruct, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, "* args) {\n        ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, ____BAH_COMPILER_VAR_714, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, "(", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, unSerMembs, strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, ");\n    };\n    {\n        ", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, tmpArgsStruct, strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, " ", strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, tmpArgs, strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, " = {", strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, ____BAH_COMPILER_VAR_715, strLen_13);
                    currStrOff += strLen_13;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, "};\n        pthread_t id;\n        ", strLen_14);
                    currStrOff += strLen_14;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, tCreate, strLen_15);
                    currStrOff += strLen_15;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, "(&id, 0, ", strLen_16);
                    currStrOff += strLen_16;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, fnWrapper, strLen_17);
                    currStrOff += strLen_17;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, ", &", strLen_18);
                    currStrOff += strLen_18;
                    
                    memcpy(____BAH_COMPILER_VAR_716+currStrOff, tmpArgs, strLen_19);
                    currStrOff += strLen_19;
...
char * ____BAH_COMPILER_VAR_718 =ntt.str((struct string*)&ntt);char * ____BAH_COMPILER_VAR_719 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_719+currStrOff, "Cannot use var {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_719+currStrOff, ____BAH_COMPILER_VAR_718, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_719+currStrOff, ") as channel.", strLen_2);
                    currStrOff += strLen_2;
...
char * ____BAH_COMPILER_VAR_724 =ntt.str((struct string*)&ntt);struct string ct =  getCType(____BAH_COMPILER_VAR_724,elems);
if (RCPavailable()) {
char * ____BAH_COMPILER_VAR_725 =ntt.str((struct string*)&ntt);char * ____BAH_COMPILER_VAR_726 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_726+currStrOff, ____BAH_COMPILER_VAR_725, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_731+currStrOff, "->receive(", strLen_4);
                    currStrOff += strLen_4;
...
t.isFunc =  true;
if (RCPavailable()) {
char * ____BAH_COMPILER_VAR_732 =ntt.str((struct string*)&ntt);if (isRCPpointerType(____BAH_COMPILER_VAR_732)) {
char * ____BAH_COMPILER_VAR_733 =ntt.str((struct string*)&ntt);tmpV =  registerRCPvar(____BAH_COMPILER_VAR_733,t.cont,elems);
t.type =  TOKEN_TYPE_VAR;
t.isFunc =  false;
t.cont =  tmpV;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_735+currStrOff, "Cannot use var {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_735+currStrOff, ntt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_735+currStrOff, ") as channel.", strLen_2);
                    currStrOff += strLen_2;
...
char * ____BAH_COMPILER_VAR_736 =ptt.str((struct string*)&ptt);if ((compTypes(____BAH_COMPILER_VAR_736,ntt)==false)) {
char * ____BAH_COMPILER_VAR_737 =ptt.str((struct string*)&ptt);char * ____BAH_COMPILER_VAR_738 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_738+currStrOff, "Cannot send {TOKEN} (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_738+currStrOff, ntt, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_738+currStrOff, ") to channel of type ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_738+currStrOff, ____BAH_COMPILER_VAR_737, strLen_3);
                    currStrOff += strLen_3;
...
i =  i+1;
char * ____BAH_COMPILER_VAR_739 =ptt.str((struct string*)&ptt);if (isRCPpointerType(____BAH_COMPILER_VAR_739)) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_740+currStrOff, "->send(", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_740+currStrOff, pt.cont, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_740+currStrOff, ", ", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_740+currStrOff, nt.cont, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_742+currStrOff, ____BAH_COMPILER_VAR_741, strLen_1);
                    currStrOff += strLen_1;
                    ...
                    memcpy(____BAH_COMPILER_VAR_742+currStrOff, "->sendAny(", strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_742+currStrOff, pt.cont, strLen_9);
                    currStrOff += strLen_9;
                    ...
                    memcpy(____BAH_COMPILER_VAR_742+currStrOff, ", sizeof(", strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_742+currStrOff, tmpV, strLen_13);
                    currStrOff += strLen_13;
...
long int i =  0;
struct func* ____BAH_COMPILER_VAR_743 = memoryAlloc(sizeof(struct func));
...
____BAH_COMPILER_VAR_743->isBinding = false;
____BAH_COMPILER_VAR_743->from = "";
____BAH_COMPILER_VAR_743->file = "";
____BAH_COMPILER_VAR_743->line = 1;
____BAH_COMPILER_VAR_743->used = false;
____BAH_COMPILER_VAR_743->code = null;
struct func* fn =  ____BAH_COMPILER_VAR_743;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_744+currStrOff, "Cannot redeclare function {TOKEN}, previous declaration: ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_744+currStrOff, ogFn->file, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_744+currStrOff, ":", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_744+currStrOff, lineStr, strLen_3);
                    currStrOff += strLen_3;
                ...
                throwErr(&ft,____BAH_COMPILER_VAR_744);
}
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_747+currStrOff, "Function '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_747+currStrOff, fn->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_747+currStrOff, "' is not returned.", strLen_2);
                    currStrOff += strLen_2;
                    
                }
                throwErr(&l->data[len(l)-1],____BAH_COMPILER_VAR_747);
}
endRCPscope(fnElems,null);
}
...
OUTPUT =  OUTPUT->add(OUTPUT, fn->code);
if ((debug==true)) {
struct debugFunction* ____BAH_COMPILER_VAR_748 = memoryAlloc(sizeof(struct debugFunction));
____BAH_COMPILER_VAR_748->name= null;
____BAH_COMPILER_VAR_748->returns= null;
____BAH_COMPILER_VAR_748->args = memoryAlloc(sizeof(array(struct variable*)));
            ____BAH_COMPILER_VAR_748->args->length = 0;
            ____BAH_COMPILER_VAR_748->args->elemSize = sizeof(struct variable*);
            struct debugFunction* df =  ____BAH_COMPILER_VAR_748;
df->name =  fn->name;
df->args =  fn->args;
df->returns =  fn->returns->type;
struct debugFunction* ____BAH_COMPILER_VAR_749 = df;
char ** ____BAH_COMPILER_VAR_751 = (char **)((char*)(____BAH_COMPILER_VAR_749) + offsetof(struct debugFunction, name));
struct reflectElement ____BAH_COMPILER_VAR_752 = __reflect(____BAH_COMPILER_VAR_751, sizeof(char *), "cpstring", "name", 0, 0, 0, 0, offsetof(struct debugFunction, name));
char ** ____BAH_COMPILER_VAR_753 = (char **)((char*)(____BAH_COMPILER_VAR_749) + offsetof(struct debugFunction, returns));
struct reflectElement ____BAH_COMPILER_VAR_754 = __reflect(____BAH_COMPILER_VAR_753, sizeof(char *), "cpstring", "returns", 0, 0, 0, 0, offsetof(struct debugFunction, returns));
array(struct variable*)** ____BAH_COMPILER_VAR_755 = (array(struct variable*)**)((char*)(____BAH_COMPILER_VAR_749) + offsetof(struct debugFunction, args));
struct variable** ____BAH_COMPILER_VAR_756 = 0;
...
char* ____BAH_COMPILER_VAR_770 = (char*)((char*)(____BAH_COMPILER_VAR_756) + offsetof(struct variable, outterScope));
struct reflectElement ____BAH_COMPILER_VAR_771 = __reflect(____BAH_COMPILER_VAR_770, sizeof(char), "bool", "outterScope", 0, 0, 0, 0, offsetof(struct variable, outterScope));
...
struct reflectElement ____BAH_COMPILER_VAR_773 = __reflect(____BAH_COMPILER_VAR_772, sizeof(char), "bool", "isGlobal", 0, 0, 0, 0, offsetof(struct variable, isGlobal));
        ...
        ____BAH_COMPILER_VAR_757->length = 8;
...
struct reflectElement ____BAH_COMPILER_VAR_774 = __reflect(____BAH_COMPILER_VAR_756, sizeof(struct variable), "variable*", "", 0, 0, 1, ____BAH_COMPILER_VAR_757, 0);

        struct reflectElement ____BAH_COMPILER_VAR_775 = ____BAH_COMPILER_VAR_774;
        struct reflectElement ____BAH_COMPILER_VAR_776 = __reflect(____BAH_COMPILER_VAR_755, sizeof(array(struct variable*)*), "[]variable*", "args", 1, &____BAH_COMPILER_VAR_775, 0, 0, offsetof(struct debugFunction, args));

        array(struct reflectElement) * ____BAH_COMPILER_VAR_750 = memoryAlloc(sizeof(array(struct reflectElement)));
        ____BAH_COMPILER_VAR_750->elemSize = sizeof(struct reflectElement);
        ____BAH_COMPILER_VAR_750->length = 3;
        ____BAH_COMPILER_VAR_750->data = memoryAlloc(____BAH_COMPILER_VAR_750->length * ____BAH_COMPILER_VAR_750->elemSize);
        ____BAH_COMPILER_VAR_750->data[0] = ____BAH_COMPILER_VAR_752;
____BAH_COMPILER_VAR_750->data[1] = ____BAH_COMPILER_VAR_754;
____BAH_COMPILER_VAR_750->data[2] = ____BAH_COMPILER_VAR_776;
struct reflectElement ____BAH_COMPILER_VAR_777 = __reflect(____BAH_COMPILER_VAR_749, sizeof(struct debugFunction), "debugFunction*", "df", 0, 0, 1, ____BAH_COMPILER_VAR_750, 0);
debugPrint("fn_declare",ft.line,____BAH_COMPILER_VAR_777);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_778+currStrOff, ft.cont, strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_780+currStrOff, arg->name, strLen_3);
                    currStrOff += strLen_3;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_781+currStrOff, tmpfnArgsCType, strLen_0);
                    currStrOff += strLen_0;
                ...
                tmpfnArgsCType =  ____BAH_COMPILER_VAR_781;
}
};
char * ____BAH_COMPILER_VAR_782 =tmpfnRetCType.str((struct string*)&tmpfnRetCType);char * ____BAH_COMPILER_VAR_783 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_5 = strlen(");\n");
;                            
                    ____BAH_COMPILER_VAR_783 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5);
                    ...
                    memcpy(____BAH_COMPILER_VAR_783+currStrOff, fn->name, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_783+currStrOff, "(", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_783+currStrOff, tmpfnArgsCType, strLen_4);
                    currStrOff += strLen_4;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_784+currStrOff, "#define ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_784+currStrOff, v->name, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_784+currStrOff, " ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_784+currStrOff, v->constVal, strLen_3);
                    currStrOff += strLen_3;
...
struct string cType =  getCType(v->type,elems);
char * ____BAH_COMPILER_VAR_785 =cType.str((struct string*)&cType);char * ____BAH_COMPILER_VAR_786 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(____BAH_COMPILER_VAR_785);
long int strLen_1 = strlen(" ");
long int strLen_2 = strlen(v->name);
long int strLen_3 = strlen(";\n");
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_786+currStrOff, ____BAH_COMPILER_VAR_785, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_786+currStrOff, " ", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_786+currStrOff, v->name, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_787+currStrOff, "#include ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_787+currStrOff, compilerState.cIncludes->data[i], strLen_1);
                    currStrOff += strLen_1;
...
char * ____BAH_COMPILER_VAR_788 =elemType.str((struct string*)&elemType);struct string elemCtype =  getCType(____BAH_COMPILER_VAR_788,elems);
char * ____BAH_COMPILER_VAR_789 =elemCtype.str((struct string*)&elemCtype);char * ____BAH_COMPILER_VAR_790 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_790+currStrOff, t, strLen_3);
                    currStrOff += strLen_3;
...
struct flags ____BAH_COMPILER_VAR_791 = {};
____BAH_COMPILER_VAR_791.flags = memoryAlloc(sizeof(array(struct flag*)));
            ____BAH_COMPILER_VAR_791.flags->length = 0;
            ____BAH_COMPILER_VAR_791.flags->elemSize = sizeof(struct flag*);
            ____BAH_COMPILER_VAR_791.args = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_791.args->length = 0;
            ____BAH_COMPILER_VAR_791.args->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_791.addString = flags__addString;
____BAH_COMPILER_VAR_791.addBool = flags__addBool;
____BAH_COMPILER_VAR_791.addInt = flags__addInt;
____BAH_COMPILER_VAR_791.addFloat = flags__addFloat;
____BAH_COMPILER_VAR_791.invalidate = flags__invalidate;
____BAH_COMPILER_VAR_791.getFlag = flags__getFlag;
____BAH_COMPILER_VAR_791.get = flags__get;
____BAH_COMPILER_VAR_791.getInt = flags__getInt;
____BAH_COMPILER_VAR_791.getFloat = flags__getFloat;
____BAH_COMPILER_VAR_791.isSet = flags__isSet;
____BAH_COMPILER_VAR_791.parse = flags__parse;
flags =  ____BAH_COMPILER_VAR_791;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_792+currStrOff, "Select the target OS for cross compilling (linux, windows, darwin), default: ", strLen_0);
                    currStrOff += strLen_0;
                ...
                flags.addString((struct flags*)&flags,"target",____BAH_COMPILER_VAR_792);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_793+currStrOff, "If your Bah directory is not the default one (", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_793+currStrOff, BAH_DIR, strLen_1);
                    currStrOff += strLen_1;
                ...
                flags.addString((struct flags*)&flags,"bahDir",____BAH_COMPILER_VAR_793);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_794+currStrOff, "To change the C compiler used, default: ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_794+currStrOff, BAH_CC, strLen_1);
                    currStrOff += strLen_1;
                ...
                flags.addString((struct flags*)&flags,"CC",____BAH_COMPILER_VAR_794);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_795+currStrOff, "Build target: ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_795+currStrOff, BAH_OS, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_796+currStrOff, BAH_DIR, strLen_0);
                    currStrOff += strLen_0;
                ...
                BAH_DIR =  ____BAH_COMPILER_VAR_796;
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_797+currStrOff, "Bah directory: ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_797+currStrOff, BAH_DIR, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_798+currStrOff, "C compiler: ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_798+currStrOff, BAH_CC, strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_799+currStrOff, "Bah compiler version: ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_799+currStrOff, BAH_VERSION, strLen_1);
                    currStrOff += strLen_1;
...
struct compilerStateTag ____BAH_COMPILER_VAR_800 = {};
____BAH_COMPILER_VAR_800.includes = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_800.includes->length = 0;
            ____BAH_COMPILER_VAR_800.includes->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_800.cIncludes = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_800.cIncludes->length = 0;
            ____BAH_COMPILER_VAR_800.cIncludes->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_800.cLibs = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_800.cLibs->length = 0;
            ____BAH_COMPILER_VAR_800.cLibs->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_800.currentFile= null;
____BAH_COMPILER_VAR_800.currentDir = "./";
____BAH_COMPILER_VAR_800.isBranch = false;
____BAH_COMPILER_VAR_800.isFor = false;
____BAH_COMPILER_VAR_800.arrTypesDecl = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_800.arrTypesDecl->length = 0;
            ____BAH_COMPILER_VAR_800.arrTypesDecl->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_800.haveEntryPoint = false;
____BAH_COMPILER_VAR_800.RCPvars = memoryAlloc(sizeof(array(struct variable*)));
            ____BAH_COMPILER_VAR_800.RCPvars->length = 0;
            ____BAH_COMPILER_VAR_800.RCPvars->elemSize = sizeof(struct variable*);
            ____BAH_COMPILER_VAR_800.evals = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_800.evals->length = 0;
            ____BAH_COMPILER_VAR_800.evals->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_800.hasImports = false;
compilerState =  ____BAH_COMPILER_VAR_800;
...
compilerState.currentFile =  fileName;
struct fileMap ____BAH_COMPILER_VAR_801 = {};
____BAH_COMPILER_VAR_801.handle = -1;
____BAH_COMPILER_VAR_801.p= null;
____BAH_COMPILER_VAR_801.open = fileMap__open;
____BAH_COMPILER_VAR_801.isValid = fileMap__isValid;
____BAH_COMPILER_VAR_801.close = fileMap__close;
struct fileMap fm =  ____BAH_COMPILER_VAR_801;
char * f =  fm.open((struct fileMap*)&fm,fileName);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_802+currStrOff, "Could not open file '", strLen_0);
                    currStrOff += strLen_0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_803+currStrOff, "File '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_803+currStrOff, fileName, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_803+currStrOff, "' not recognized.", strLen_2);
                    currStrOff += strLen_2;
...
struct Elems* ____BAH_COMPILER_VAR_804 = memoryAlloc(sizeof(struct Elems));
____BAH_COMPILER_VAR_804->vars = memoryAlloc(sizeof(array(struct variable*)));
            ____BAH_COMPILER_VAR_804->vars->length = 0;
            ____BAH_COMPILER_VAR_804->vars->elemSize = sizeof(struct variable*);
            ____BAH_COMPILER_VAR_804->structs = memoryAlloc(sizeof(array(struct cStruct*)));
            ____BAH_COMPILER_VAR_804->structs->length = 0;
            ____BAH_COMPILER_VAR_804->structs->elemSize = sizeof(struct cStruct*);
            ____BAH_COMPILER_VAR_804->types = memoryAlloc(sizeof(array(char *)));
            ____BAH_COMPILER_VAR_804->types->length = 0;
            ____BAH_COMPILER_VAR_804->types->elemSize = sizeof(char *);
            ____BAH_COMPILER_VAR_804->fns = memoryAlloc(sizeof(array(struct func*)));
            ____BAH_COMPILER_VAR_804->fns->length = 0;
            ____BAH_COMPILER_VAR_804->fns->elemSize = sizeof(struct func*);
            struct Elems* elems =  ____BAH_COMPILER_VAR_804;
if ((isObject==true)) {
OUTPUT =  rope("\n        #define noCheck(v) v\n        #define array(type)	\
        struct{	\
        type *data; \
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_805+currStrOff, "Could not find std-libs, please check '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_805+currStrOff, BAH_DIR, strLen_1);
                    currStrOff += strLen_1;
                ...
                __BAH_panic(____BAH_COMPILER_VAR_805,"/home/alois/Documents/bah-bah/src/main.bah:218");
}
shouldOnlyDecl =  false;
if ((flags.isSet((struct flags*)&flags,"l")==1)) {
OUTPUT =  rope("");
...
char * ____BAH_COMPILER_VAR_806 =intToStr(l);char * ____BAH_COMPILER_VAR_807 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_808+currStrOff, fn->from, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_808+currStrOff, "__", strLen_1);
                    currStrOff += strLen_1;
                    
                }
                if (((strcmp(fn->from, "") != 0)&&strHasPrefix(name,____BAH_COMPILER_VAR_808))) {
struct string n =  string(name);
n.trimLeft((struct string*)&n,strlen(fn->from) + 2);
char * ____BAH_COMPILER_VAR_809 =n.str((struct string*)&n);char * ____BAH_COMPILER_VAR_810 =null;
                {
                    long int currStrOff = 0;
                    long int strLen_0 = strlen(fn->from);
long int strLen_1 = strlen(".");
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_810+currStrOff, fn->from, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_810+currStrOff, ".", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_810+currStrOff, ____BAH_COMPILER_VAR_809, strLen_2);
                    currStrOff += strLen_2;
                    
                }
                name =  ____BAH_COMPILER_VAR_810;
}
char * ____BAH_COMPILER_VAR_811 =intToStr(j);char * ____BAH_COMPILER_VAR_812 =intToStr(j);char * ____BAH_COMPILER_VAR_813 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_3 = strlen(name);
long int strLen_4 = strlen("\";\n            __tmp____Bah_fnNames[");
long int strLen_5 = strlen(____BAH_COMPILER_VAR_812);
long int strLen_6 = strlen("].p = ");
long int strLen_7 = strlen(fn->name);
long int strLen_8 = strlen(";\n");
;                            
                    ____BAH_COMPILER_VAR_813 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8);
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, "\n            __tmp____Bah_fnNames[", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, ____BAH_COMPILER_VAR_811, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, "].n = \"", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, name, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, "\";\n            __tmp____Bah_fnNames[", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, ____BAH_COMPILER_VAR_812, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, "].p = ", strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_813+currStrOff, fn->name, strLen_7);
                    currStrOff += strLen_7;
                ...
                INIT =  INIT->add(INIT, rope(____BAH_COMPILER_VAR_813));
j =  j+1;
};
char * ____BAH_COMPILER_VAR_814 =intToStr(l);char * ____BAH_COMPILER_VAR_815 =null;
                {
                    long int currStrOff = 0;
...
char * ____BAH_COMPILER_VAR_816 =intToStr(totalLines);char * ____BAH_COMPILER_VAR_817 =intToStr(totalTime / 1000000);char * ____BAH_COMPILER_VAR_818 =intToStr(totalLexerTime / 1000000);char * ____BAH_COMPILER_VAR_819 =null;
                {
                    long int currStrOff = 0;
...
long int strLen_3 = strlen(____BAH_COMPILER_VAR_817);
long int strLen_4 = strlen("ms, lexer time: ");
long int strLen_5 = strlen(____BAH_COMPILER_VAR_818);
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_819+currStrOff, ____BAH_COMPILER_VAR_816, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_819+currStrOff, " lines, total time: ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_819+currStrOff, ____BAH_COMPILER_VAR_817, strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_819+currStrOff, "ms, lexer time: ", strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_819+currStrOff, ____BAH_COMPILER_VAR_818, strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_819+currStrOff, "ms)\e[0m", strLen_6);
                    currStrOff += strLen_6;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_820+currStrOff, fileName, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_820+currStrOff, ".o", strLen_1);
                    currStrOff += strLen_1;
                    
                }
                fileName =  ____BAH_COMPILER_VAR_820;
obj =  "-c";
}
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, BAH_CC, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, " -I \"", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, BAH_DIR, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, "libs/", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, BAH_OS, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, "/include/\" -L \"", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, BAH_DIR, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, "libs/", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, BAH_OS, strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, "/\" ", strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, randFileName, strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, " ", strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, isStatic, strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, " ", strLen_13);
                    currStrOff += strLen_13;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, obj, strLen_14);
                    currStrOff += strLen_14;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, " -w -O1 -o ", strLen_15);
                    currStrOff += strLen_15;
                    
                    memcpy(____BAH_COMPILER_VAR_821+currStrOff, fileName, strLen_16);
                    currStrOff += strLen_16;
                    
                }
                char * gccArgs =  ____BAH_COMPILER_VAR_821;
if ((flags.isSet((struct flags*)&flags,"l")==1)) {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_822+currStrOff, " -c", strLen_1);
                    currStrOff += strLen_1;
...
if ((flags.isSet((struct flags*)&flags,"verboseCC")==1)) {
char * ____BAH_COMPILER_VAR_824 =cmd.run((struct command*)&cmd);println(____BAH_COMPILER_VAR_824);
}
else {
...
;                            
                    ____BAH_COMPILER_VAR_825 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3);
                    
                    memcpy(____BAH_COMPILER_VAR_825+currStrOff, "ar rcs ", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_825+currStrOff, fileName, strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_825+currStrOff, ".a ", strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_825+currStrOff, fileName, strLen_3);
                    currStrOff += strLen_3;
                    
                }
                cmd =  command(____BAH_COMPILER_VAR_825);
cmd.run((struct command*)&cmd);
}
}
else {
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_826+currStrOff, fileName, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_826+currStrOff, ".c", strLen_1);
                    currStrOff += strLen_1;
...
;                            
                    ____BAH_COMPILER_VAR_827 = memoryAllocSTR(1 + strLen_0 + strLen_1 + strLen_2 + strLen_3 + strLen_4 + strLen_5 + strLen_6 + strLen_7 + strLen_8 + strLen_9 + strLen_10 + strLen_11 + strLen_12 + strLen_13);
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, BAH_CC, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, " -I \"", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, BAH_DIR, strLen_2);
                    currStrOff += strLen_2;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, "libs/", strLen_3);
                    currStrOff += strLen_3;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, BAH_OS, strLen_4);
                    currStrOff += strLen_4;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, "/include/\" -L \"", strLen_5);
                    currStrOff += strLen_5;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, BAH_DIR, strLen_6);
                    currStrOff += strLen_6;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, "libs/", strLen_7);
                    currStrOff += strLen_7;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, BAH_OS, strLen_8);
                    currStrOff += strLen_8;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, "/\" ", strLen_9);
                    currStrOff += strLen_9;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, fileName, strLen_10);
                    currStrOff += strLen_10;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, " ", strLen_11);
                    currStrOff += strLen_11;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, isStatic, strLen_12);
                    currStrOff += strLen_12;
                    
                    memcpy(____BAH_COMPILER_VAR_827+currStrOff, " -O1 -w ", strLen_13);
                    currStrOff += strLen_13;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_828+currStrOff, gccArgs, strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_828+currStrOff, " -", strLen_1);
                    currStrOff += strLen_1;
                    
                    memcpy(____BAH_COMPILER_VAR_828+currStrOff, l, strLen_2);
                    currStrOff += strLen_2;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_829+currStrOff, "//COMPILE WITH: '", strLen_0);
                    currStrOff += strLen_0;
                    
                    memcpy(____BAH_COMPILER_VAR_829+currStrOff, gccArgs, strLen_1);
                    currStrOff += strLen_1;
                ...
                OUTPUT =  rope(____BAH_COMPILER_VAR_829)->add(rope(____BAH_COMPILER_VAR_829), OUTPUT);
struct fileStream ____BAH_COMPILER_VAR_830 = {};
____BAH_COMPILER_VAR_830.handle= null;
____BAH_COMPILER_VAR_830.isValid = fileStream__isValid;
____BAH_COMPILER_VAR_830.open = fileStream__open;
____BAH_COMPILER_VAR_830.close = fileStream__close;
____BAH_COMPILER_VAR_830.getPos = fileStream__getPos;
____BAH_COMPILER_VAR_830.setPos = fileStream__setPos;
____BAH_COMPILER_VAR_830.getSize = fileStream__getSize;
____BAH_COMPILER_VAR_830.rewind = fileStream__rewind;
____BAH_COMPILER_VAR_830.getChar = fileStream__getChar;
____BAH_COMPILER_VAR_830.setChar = fileStream__setChar;
____BAH_COMPILER_VAR_830.createFile = fileStream__createFile;
____BAH_COMPILER_VAR_830.writeFile = fileStream__writeFile;
____BAH_COMPILER_VAR_830.writePtr = fileStream__writePtr;
____BAH_COMPILER_VAR_830.readPtr = fileStream__readPtr;
____BAH_COMPILER_VAR_830.readContent = fileStream__readContent;
____BAH_COMPILER_VAR_830.readBytes = fileStream__readBytes;
____BAH_COMPILER_VAR_830.writeBytes = fileStream__writeBytes;
struct fileStream fs =  ____BAH_COMPILER_VAR_830;
fs.open((struct fileStream*)&fs,fileName,"w");
char * ____BAH_COMPILER_VAR_831 =OUTPUT->toStr((struct rope*)OUTPUT);fs.writeFile((struct fileStream*)&fs,____BAH_COMPILER_VAR_831);
fs.close((struct fileStream*)&fs);
}
if ((isObject==false)) {
long int totalTime =  getTimeUnix() - startTime;
char * ____BAH_COMPILER_VAR_832 =intToStr(totalTime / 1000000);char * ____BAH_COMPILER_VAR_833 =null;
                {
                    long int currStrOff = 0;
...
;                            
                    ...
                    memcpy(____BAH_COMPILER_VAR_833+currStrOff, "ms)\e[0m", strLen_2);
                    currStrOff += strLen_2;
